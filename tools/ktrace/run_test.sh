...
rm $K3HOME/__build/A $K3HOME/__build/__build/* || true
#
# Compile the K3 executable
cd $K3HOME && tools/scripts/run/compile.sh $INFILE
...
$K3HOME/__build/A -p $TESTDIR/peers.yaml --result_var $RESULTVAR --result_path $TESTDIR/results/
