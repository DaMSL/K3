...
typedef ConcurrentMap<Address, shared_ptr<InternalOutgoingConnection>> InternalConnectionMap;
typedef ConcurrentMap<Address, shared_ptr<ExternalOutgoingConnection>> ExternalConnectionMap;
