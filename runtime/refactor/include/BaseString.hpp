...
class base_string {
 public:
  ...
  //Seq<R_elem<string_impl>> splitString(const string_impl& splitter); // Modifies this string.
...
//namespace YAML {
//template <>
//struct convert<base_string> {
//  static Node encode(const base_string& s) {
//    Node node;
//    node = std::string(s.c_str());
//    return node;
//  }
//
//  static bool decode(const Node& node, base_string& s) {
//    try {
