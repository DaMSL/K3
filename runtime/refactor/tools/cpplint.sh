...
./tools/external/cpplint.py \
  --filter=-legal/copyright,-runtime/printf,-runtime/invalid_increment,-runtime/int,-runtime/references,-runtime/explicit,-build/c++11 --extensions=hpp,cpp --linelength=100 \
