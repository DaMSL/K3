...
#endif
#ifndef K3_R_l_epd_l_suppkey_hash_value
#define K3_R_l_epd_l_suppkey_hash_value
template <class _T0, class _T1>
class R_l_epd_l_suppkey {
  public:
      R_l_epd_l_suppkey(): l_epd(), l_suppkey()  {}
      template <class __T0, class __T1>
      R_l_epd_l_suppkey(__T0&& _l_epd, __T1&& _l_suppkey): l_epd(std::forward<__T0>(_l_epd)),
      l_suppkey(std::forward<__T1>(_l_suppkey))  {}
      bool operator==(const R_l_epd_l_suppkey<_T0, _T1>& __other) const {
        return l_epd == (__other.l_epd) && l_suppkey == (__other.l_suppkey);
      }
      bool operator!=(const R_l_epd_l_suppkey<_T0, _T1>& __other) const {
        return std::tie(l_epd, l_suppkey) != std::tie(__other.l_epd, __other.l_suppkey);
      }
      bool operator<(const R_l_epd_l_suppkey<_T0, _T1>& __other) const {
        return std::tie(l_epd, l_suppkey) < std::tie(__other.l_epd, __other.l_suppkey);
      }
...
namespace K3 {
  template <class _T0, class _T1>
  class patcher<R_l_epd_l_suppkey<_T0, _T1>> {
    public:
        static void patch(std::string _input, R_l_epd_l_suppkey<_T0, _T1>& _record)  {
          shallow<string::iterator> _shallow;
          qi::rule<string::iterator,
          qi::space_type> _l_epd = (qi::lit("l_epd") >> (':') >> _shallow)[([&_record] (std::string _partial)   {
            do_patch(_partial, _record.l_epd);
          })];
          qi::rule<string::iterator,
          qi::space_type> _l_suppkey = (qi::lit("l_suppkey") >> (':') >> _shallow)[([&_record] (std::string _partial)   {
            do_patch(_partial, _record.l_suppkey);
...
#ifndef K3_R_l_epd_l_suppkey
#define K3_R_l_epd_l_suppkey
template <class _T0, class _T1>
std::size_t hash_value(const R_l_epd_l_suppkey<_T0, _T1>& r)  {
  boost::hash<std::tuple<_T0, _T1>> hasher;
  return hasher(std::tie(r.l_epd, r.l_suppkey));
}
#endif
...
#endif
#ifndef K3_R_n_name_n_regionkey_hash_value
#define K3_R_n_name_n_regionkey_hash_value
template <class _T0, class _T1>
class R_n_name_n_regionkey {
  public:
      R_n_name_n_regionkey(): n_name(), n_regionkey()  {}
      template <class __T0, class __T1>
      R_n_name_n_regionkey(__T0&& _n_name,
      __T1&& _n_regionkey): n_name(std::forward<__T0>(_n_name)),
      n_regionkey(std::forward<__T1>(_n_regionkey))  {}
      bool operator==(const R_n_name_n_regionkey<_T0, _T1>& __other) const {
        return n_name == (__other.n_name) && n_regionkey == (__other.n_regionkey);
      }
      bool operator!=(const R_n_name_n_regionkey<_T0, _T1>& __other) const {
        return std::tie(n_name, n_regionkey) != std::tie(__other.n_name, __other.n_regionkey);
      }
      bool operator<(const R_n_name_n_regionkey<_T0, _T1>& __other) const {
        return std::tie(n_name, n_regionkey) < std::tie(__other.n_name, __other.n_regionkey);
      }
...
namespace K3 {
  template <class _T0, class _T1>
  class patcher<R_n_name_n_regionkey<_T0, _T1>> {
    public:
        static void patch(std::string _input, R_n_name_n_regionkey<_T0, _T1>& _record)  {
          shallow<string::iterator> _shallow;
          qi::rule<string::iterator,
          qi::space_type> _n_name = (qi::lit("n_name") >> (':') >> _shallow)[([&_record] (std::string _partial)   {
            do_patch(_partial, _record.n_name);
...
#ifndef K3_R_n_name_n_regionkey
#define K3_R_n_name_n_regionkey
template <class _T0, class _T1>
std::size_t hash_value(const R_n_name_n_regionkey<_T0, _T1>& r)  {
  boost::hash<std::tuple<_T0, _T1>> hasher;
  return hasher(std::tie(r.n_name, r.n_regionkey));
}
#endif
...
#endif
#ifndef K3_R_s_nationkey_s_suppkey_hash_value
#define K3_R_s_nationkey_s_suppkey_hash_value
template <class _T0, class _T1>
class R_s_nationkey_s_suppkey {
  public:
      R_s_nationkey_s_suppkey(): s_nationkey(), s_suppkey()  {}
      template <class __T0, class __T1>
      R_s_nationkey_s_suppkey(__T0&& _s_nationkey,
      __T1&& _s_suppkey): s_nationkey(std::forward<__T0>(_s_nationkey)),
      s_suppkey(std::forward<__T1>(_s_suppkey))  {}
      bool operator==(const R_s_nationkey_s_suppkey<_T0, _T1>& __other) const {
        return s_nationkey == (__other.s_nationkey) && s_suppkey == (__other.s_suppkey);
      }
      bool operator!=(const R_s_nationkey_s_suppkey<_T0, _T1>& __other) const {
        return std::tie(s_nationkey, s_suppkey) != std::tie(__other.s_nationkey, __other.s_suppkey);
      }
      bool operator<(const R_s_nationkey_s_suppkey<_T0, _T1>& __other) const {
        return std::tie(s_nationkey, s_suppkey) < std::tie(__other.s_nationkey, __other.s_suppkey);
      }
...
namespace K3 {
  template <class _T0, class _T1>
  class patcher<R_s_nationkey_s_suppkey<_T0, _T1>> {
    public:
        static void patch(std::string _input, R_s_nationkey_s_suppkey<_T0, _T1>& _record)  {
          shallow<string::iterator> _shallow;
          qi::rule<string::iterator,
          qi::space_type> _s_nationkey = (qi::lit("s_nationkey") >> (':') >> _shallow)[([&_record] (std::string _partial)   {
            do_patch(_partial, _record.s_nationkey);
...
#ifndef K3_R_s_nationkey_s_suppkey
#define K3_R_s_nationkey_s_suppkey
template <class _T0, class _T1>
std::size_t hash_value(const R_s_nationkey_s_suppkey<_T0, _T1>& r)  {
  boost::hash<std::tuple<_T0, _T1>> hasher;
  return hasher(std::tie(r.s_nationkey, r.s_suppkey));
}
#endif
...
public K3::__time_context {
  public:
      ...
      K3::__time_context()  {
        ...
        dispatch_table[__locsnr_rhs_scan_tid] = [this] (void* payload)   {
          locsnr_rhs_scan(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__locsnr_rhs_peer_barrier_tid] = [this] (void* payload)   {
          locsnr_rhs_peer_barrier(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__locsnr_probe_rhs_tid] = [this] (void* payload)   {
          locsnr_probe_rhs(*(static_cast<_Collection<R_key_value<int, unit_t>>*>(payload)));
        };
        dispatch_table[__locsnr_lhs_scan_tid] = [this] (void* payload)   {
          locsnr_lhs_scan(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__locsnr_lhs_peer_barrier_tid] = [this] (void* payload)   {
          locsnr_lhs_peer_barrier(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__locsnr_global_barrier_tid] = [this] (void* payload)   {
          locsnr_global_barrier(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__locsnr_build_lhs_tid] = [this] (void* payload)   {
          locsnr_build_lhs(*(static_cast<_Collection<R_key_value<int,
          _Map<R_key_value<K3::base_string, double>>>>*>(payload)));
        };
        dispatch_table[__locsn_rhs_scan_tid] = [this] (void* payload)   {
          locsn_rhs_scan(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__locsn_rhs_peer_barrier_tid] = [this] (void* payload)   {
          locsn_rhs_peer_barrier(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__locsn_probe_rhs_tid] = [this] (void* payload)   {
          locsn_probe_rhs(*(static_cast<_Collection<R_key_value<int,
          R_n_name_n_regionkey<K3::base_string, int>>>*>(payload)));
        };
        dispatch_table[__locsn_lhs_scan_tid] = [this] (void* payload)   {
          locsn_lhs_scan(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__locsn_lhs_peer_barrier_tid] = [this] (void* payload)   {
          locsn_lhs_peer_barrier(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__locsn_global_barrier_tid] = [this] (void* payload)   {
          locsn_global_barrier(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__locsn_build_lhs_tid] = [this] (void* payload)   {
          locsn_build_lhs(*(static_cast<_Collection<R_key_value<int, double>>*>(payload)));
        };
        dispatch_table[__locs_rhs_scan_tid] = [this] (void* payload)   {
          locs_rhs_scan(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__locs_rhs_peer_barrier_tid] = [this] (void* payload)   {
          locs_rhs_peer_barrier(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__locs_probe_rhs_tid] = [this] (void* payload)   {
          locs_probe_rhs(*(static_cast<_Collection<R_key_value<int, int>>*>(payload)));
        };
        dispatch_table[__locs_lhs_scan_tid] = [this] (void* payload)   {
          locs_lhs_scan(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__locs_lhs_peer_barrier_tid] = [this] (void* payload)   {
          locs_lhs_peer_barrier(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__locs_global_barrier_tid] = [this] (void* payload)   {
          locs_global_barrier(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__locs_build_lhs_tid] = [this] (void* payload)   {
          locs_build_lhs(*(static_cast<_Collection<R_key_value<R_s_nationkey_s_suppkey<int, int>,
          double>>*>(payload)));
        };
        ...
        dispatch_table[__loc_probe_rhs_tid] = [this] (void* payload)   {
          loc_probe_rhs(*(static_cast<_Collection<R_key_value<int, int>>*>(payload)));
        };
        ...
        dispatch_table[__loc_build_lhs_tid] = [this] (void* payload)   {
          ...
          _Collection<R_l_epd_l_suppkey<double, int>>>>*>(payload)));
        };
        dispatch_table[__load_all_tid] = [this] (void* payload)   {
          load_all(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__lo_rhs_scan_tid] = [this] (void* payload)   {
          lo_rhs_scan(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__lo_rhs_peer_barrier_tid] = [this] (void* payload)   {
          lo_rhs_peer_barrier(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__lo_probe_rhs_tid] = [this] (void* payload)   {
          lo_probe_rhs(*(static_cast<_Collection<R_key_value<int, int>>*>(payload)));
        };
        dispatch_table[__lo_lhs_scan_tid] = [this] (void* payload)   {
          lo_lhs_scan(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__lo_lhs_peer_barrier_tid] = [this] (void* payload)   {
          lo_lhs_peer_barrier(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__lo_global_barrier_tid] = [this] (void* payload)   {
          lo_global_barrier(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__lo_build_lhs_tid] = [this] (void* payload)   {
          lo_build_lhs(*(static_cast<_Collection<R_key_value<int,
          _Collection<R_l_epd_l_suppkey<double, int>>>>*>(payload)));
        };
        ...
        dispatch_table[__q5_result_aggregate_tid] = [this] (void* payload)   {
          q5_result_aggregate(*(static_cast<_Map<R_key_value<K3::base_string, double>>*>(payload)));
        };
        dispatch_table[__q5_locsnr_start_tid] = [this] (void* payload)   {
          q5_locsnr_start(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__q5_locsn_start_tid] = [this] (void* payload)   {
          q5_locsn_start(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__q5_locs_start_tid] = [this] (void* payload)   {
          q5_locs_start(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__q5_loc_start_tid] = [this] (void* payload)   {
          q5_loc_start(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__q5_lo_start_tid] = [this] (void* payload)   {
          q5_lo_start(*(static_cast<unit_t*>(payload)));
        };
      }
      static int __q5_lo_start_tid;
      static int __q5_loc_start_tid;
      static int __q5_locs_start_tid;
      static int __q5_locsn_start_tid;
      static int __q5_locsnr_start_tid;
      static int __q5_result_aggregate_tid;
      static int __start_tid;
      static int __finished_tid;
      static int __hello_tid;
      static int __lo_build_lhs_tid;
      static int __lo_global_barrier_tid;
      static int __lo_lhs_peer_barrier_tid;
      static int __lo_lhs_scan_tid;
      static int __lo_probe_rhs_tid;
      static int __lo_rhs_peer_barrier_tid;
      static int __lo_rhs_scan_tid;
      ...
      static int __locs_build_lhs_tid;
      static int __locs_global_barrier_tid;
      static int __locs_lhs_peer_barrier_tid;
      static int __locs_lhs_scan_tid;
      static int __locs_probe_rhs_tid;
      static int __locs_rhs_peer_barrier_tid;
      static int __locs_rhs_scan_tid;
      static int __locsn_build_lhs_tid;
      static int __locsn_global_barrier_tid;
      static int __locsn_lhs_peer_barrier_tid;
      static int __locsn_lhs_scan_tid;
      static int __locsn_probe_rhs_tid;
      static int __locsn_rhs_peer_barrier_tid;
      static int __locsn_rhs_scan_tid;
      static int __locsnr_build_lhs_tid;
      static int __locsnr_global_barrier_tid;
      static int __locsnr_lhs_peer_barrier_tid;
      static int __locsnr_lhs_scan_tid;
      static int __locsnr_probe_rhs_tid;
      static int __locsnr_rhs_peer_barrier_tid;
      static int __locsnr_rhs_scan_tid;
      ...
      K3::base_string, K3::base_string, K3::base_string, int, K3::base_string, int>> supplier;
      _Collection<R_n_comments_n_name_n_nationkey_n_regionkey<K3::base_string, K3::base_string, int,
      int>> nation;
      _Collection<R_r_comments_r_name_r_regionkey<K3::base_string, K3::base_string, int>> region;
      _Map<R_key_value<K3::base_string, double>> q5_result;
      _Map<R_key_value<int, _Collection<R_l_epd_l_suppkey<double, int>>>> lior_build;
      _Map<R_key_value<int, _Collection<R_l_epd_l_suppkey<double, int>>>> lior_cse_by_ck;
      _Map<R_key_value<int, _Collection<R_l_epd_l_suppkey<double, int>>>> loc_build;
      _Map<R_key_value<R_s_nationkey_s_suppkey<int, int>, double>> loc_epd_by_sn;
      _Map<R_key_value<R_s_nationkey_s_suppkey<int, int>, double>> locs_build;
      _Map<R_key_value<int, double>> locs_epd_by_nk;
      _Map<R_key_value<int, double>> locsn_build;
      _Map<R_key_value<int, _Map<R_key_value<K3::base_string, double>>>> locsn_nepd_by_rk;
      _Map<R_key_value<int, _Map<R_key_value<K3::base_string, double>>>> locsnr_build;
      _Map<R_key_value<K3::base_string, double>> locsnr_epd_by_n;
      auto merge_lior_build(const R_key_value<int, _Collection<R_l_epd_l_suppkey<double,
      int>>>& a)  {
        return [this, a = std::move(a)] (const R_key_value<int,
        _Collection<R_l_epd_l_suppkey<double, int>>>& b) mutable  {
          return R_key_value<int, _Collection<R_l_epd_l_suppkey<double, int>>> {a.key,
          (a.value).fold(std::move([this] (_Collection<R_l_epd_l_suppkey<double,
          int>> acc) mutable  {
            return [this, acc = std::move(acc)] (const R_l_epd_l_suppkey<double, int>& r) mutable  {
              acc.insert(std::move(r));
              return std::move(acc);
            };
          }), std::move(b.value))};
        };
      }
      auto merge_lior_cse_by_ck_r(const R_key_value<int, _Collection<R_l_epd_l_suppkey<double,
      int>>>& a)  {
        return [this, a = std::move(a)] (const R_key_value<int,
        _Collection<R_l_epd_l_suppkey<double, int>>>& b) mutable  {
          return R_key_value<int, _Collection<R_l_epd_l_suppkey<double, int>>> {a.key,
      ...
      auto merge_epd_by_sn_r(const R_key_value<R_s_nationkey_s_suppkey<int, int>, double>& a)  {
        return [this, &a] (const R_key_value<R_s_nationkey_s_suppkey<int, int>,
        double>& b) mutable  {
          return R_key_value<R_s_nationkey_s_suppkey<int, int>, double> {a.key,
          (a.value) + (b.value)};
        };
      }
      auto merge_epd_by_nk_r(const R_key_value<int, double>& a)  {
        return [this, &a] (const R_key_value<int, double>& b) mutable  {
          return R_key_value<int, double> {a.key, (a.value) + (b.value)};
        };
      }
      auto merge_nepd_r(const R_key_value<K3::base_string, double>& x)  {
        return [this, &x] (const R_key_value<K3::base_string, double>& y) mutable  {
          return R_key_value<K3::base_string, double> {x.key, (x.value) + (y.value)};
        };
      }
      auto merge_nepd_by_rk_r(const R_key_value<int, _Map<R_key_value<K3::base_string,
      double>>>& a)  {
        return [this, a = std::move(a)] (const R_key_value<int, _Map<R_key_value<K3::base_string,
        double>>>& b) mutable  {
          return R_key_value<int, _Map<R_key_value<K3::base_string, double>>> {a.key,
          (a.value).fold(std::move([this] (_Map<R_key_value<K3::base_string,
          double>> acc) mutable  {
            return [this, acc = std::move(acc)] (const R_key_value<K3::base_string,
            double>& r) mutable  {
              acc.insert_with(std::move(r), std::bind(&__global_context::merge_nepd_r, std::ref(*this), std::placeholders::_1));
              return std::move(acc);
            };
          }), std::move(b.value))};
        };
      }
      unit_t q5_lo_start(unit_t _)  {
        return peers.iterate(std::move([this] (const R_addr<Address>& p) mutable  {
          auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
          __engine.send(p.addr, __lo_lhs_scan_tid, d);
          return unit_t {};
        }));
      }
      unit_t q5_loc_start(unit_t _)  {
        return peers.iterate(std::move([this] (const R_addr<Address>& p) mutable  {
          auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
      ...
      unit_t q5_locs_start(unit_t _)  {
        return peers.iterate(std::move([this] (const R_addr<Address>& p) mutable  {
          auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
          __engine.send(p.addr, __locs_lhs_scan_tid, d);
          return unit_t {};
        }));
      }
      unit_t q5_locsn_start(unit_t _)  {
        return peers.iterate(std::move([this] (const R_addr<Address>& p) mutable  {
          auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
          __engine.send(p.addr, __locsn_lhs_scan_tid, d);
          return unit_t {};
        }));
      }
      unit_t q5_locsnr_start(unit_t _)  {
        return peers.iterate(std::move([this] (const R_addr<Address>& p) mutable  {
          auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
          __engine.send(p.addr, __locsnr_lhs_scan_tid, d);
          return unit_t {};
        }));
      }
      unit_t q5_result_aggregate(const _Map<R_key_value<K3::base_string, double>>& vals)  {
        return vals.iterate(std::move([this] (const R_key_value<K3::base_string,
        double>& kv) mutable  {
          return q5_result.insert_with(std::move(kv), std::bind(&__global_context::merge_nepd_r, std::ref(*this), std::placeholders::_1));
        }));
      }
      ...
      unit_t finished(const unit_t& finishArg)  {
        ...
        if (query_done_cnt == peers.size(unit_t {})) {
          {
            unit_t result;
            print(std::move(concat("Q5 num results:",
            std::move(itos(std::move(q5_result.size(unit_t {})))))));
      ...
      unit_t lo_build_lhs(const _Collection<R_key_value<int, _Collection<R_l_epd_l_suppkey<double,
      int>>>>& vals)  {
        return vals.iterate(std::move([this] (const R_key_value<int,
        _Collection<R_l_epd_l_suppkey<double, int>>>& li) mutable  {
          return lior_build.insert_with(std::move(li), std::bind(&__global_context::merge_lior_build, std::ref(*this), std::placeholders::_1) );
        }));
      }
      unit_t lo_global_barrier(unit_t _)  {
        lo_join_done_cnt = lo_join_done_cnt + (1);
        if (lo_join_done_cnt == peers.size(unit_t {})) {
          print("Hash join done.");
          print("LI-OR join all nodes finished.");
          auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
          __engine.send(master, __q5_loc_start_tid, d);
          return unit_t {};
        } else {
          return unit_t {};
        }
      }
      unit_t lo_lhs_peer_barrier(unit_t _)  {
        print("Hash join LHS finished build.");
        lo_peer_build_done_cnt = lo_peer_build_done_cnt + (1);
        if (lo_peer_build_done_cnt == peers.size(unit_t {})) {
          return peers.iterate(std::move([this] (const R_addr<Address>& p) mutable  {
            auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
            __engine.send(p.addr, __lo_rhs_scan_tid, d);
            return unit_t {};
          }));
        } else {
          return unit_t {};
      ...
      unit_t lo_lhs_scan(unit_t _)  {
        ...
        }), std::move([this] (_Collection<R_l_epd_l_suppkey<double, int>> acc) mutable  {
          return [this,
          acc = std::move(acc)] (const R_l_comments_l_commitdate_l_discount_l_extendedprice_l_linenumber_l_linestatus_l_orderkey_l_partkey_l_quantity_l_receiptdate_l_returnflag_l_shipdate_l_shipinstruct_l_shipmode_l_suppkey_l_tax<K3::base_string,
          K3::base_string, double, double, int, K3::base_string, int, int, double, K3::base_string,
          K3::base_string, K3::base_string, K3::base_string, K3::base_string, int,
          double>& li) mutable  {
            acc.insert(R_l_epd_l_suppkey<double,
            int> {(li.l_extendedprice) * ((1) - (li.l_discount)), li.l_suppkey});
            return std::move(acc);
          };
        }), _Collection<R_l_epd_l_suppkey<double,
        int>> {})).groupBy(std::move([this] (const R_key_value<int,
        _Collection<R_l_epd_l_suppkey<double, int>>>& v) mutable  {
          return index_by_hash(std::move(v.key));
        }), std::move([this] (_Collection<R_key_value<int, _Collection<R_l_epd_l_suppkey<double,
        int>>>> acc) mutable  {
        ...
        }), _Collection<R_key_value<int, _Collection<R_l_epd_l_suppkey<double,
        int>>>> {})).iterate(std::move([this] (const R_key_value<int, _Collection<R_key_value<int,
        _Collection<R_l_epd_l_suppkey<double, int>>>>>& v) mutable  {
          ...
          if (__0) {
            ...
            _Collection<R_l_epd_l_suppkey<double, int>>>>>>(v.value);
            __engine.send(p.addr, __lo_build_lhs_tid, d);
            return unit_t {};
          } else {
        ...
        return ignore(std::move(peers.iterate(std::move([this] (const R_addr<Address>& p) mutable  {
          auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
          __engine.send(p.addr, __lo_lhs_peer_barrier_tid, d);
          return unit_t {};
        }))));
      }
      unit_t lo_probe_rhs(const _Collection<R_key_value<int, int>>& vals)  {
        return vals.iterate(std::move([this] (const R_key_value<int, int>& o) mutable  {
          shared_ptr<R_key_value<int, _Collection<R_l_epd_l_suppkey<double, int>>>> __1;
          __1 = lior_build.lookup(R_key_value<int, _Collection<R_l_epd_l_suppkey<double,
          int>>> {o.key, _Collection<R_l_epd_l_suppkey<double, int>> {}});
          if (__1) {
            auto& li = *(__1);
            return lior_cse_by_ck.insert_with(R_key_value<int, _Collection<R_l_epd_l_suppkey<double,
            int>>> {o.value, li.value}, std::bind(&__global_context::merge_lior_cse_by_ck_r, std::ref(*this), std::placeholders::_1));
          } else {
            return unit_t {};
          }
        }));
      }
      unit_t lo_rhs_peer_barrier(unit_t _)  {
        lo_rhs_done_cnt = lo_rhs_done_cnt + (1);
        if (lo_rhs_done_cnt == peers.size(unit_t {})) {
          print("Hash join RHS finished probe.");
          print("LI-OR join finished orders probe.");
          auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
          __engine.send(master, __lo_global_barrier_tid, d);
          return unit_t {};
        } else {
          return unit_t {};
        }
      }
      unit_t lo_rhs_scan(unit_t _)  {
        lo_lhs_done_cnt = lo_lhs_done_cnt + (1);
        if (lo_lhs_done_cnt == peers.size(unit_t {})) {
          (((orders.filter(std::move([this] (const R_o_clerk_o_comments_o_custkey_o_orderdate_o_orderkey_o_orderpriority_o_orderstatus_o_shippriority_o_totalprice<K3::base_string,
          K3::base_string, int, K3::base_string, int, K3::base_string, K3::base_string, int,
          double>& o) mutable  {
            return (o.o_orderdate) >= ("1994-01-01") && (o.o_orderdate) >= ("1995-01-01");
          }))).groupBy(std::move([this] (const R_o_clerk_o_comments_o_custkey_o_orderdate_o_orderkey_o_orderpriority_o_orderstatus_o_shippriority_o_totalprice<K3::base_string,
          K3::base_string, int, K3::base_string, int, K3::base_string, K3::base_string, int,
          double>& o) mutable  {
            return o.o_orderkey;
          }), std::move([this] (int _) mutable  {
            return [this] (const R_o_clerk_o_comments_o_custkey_o_orderdate_o_orderkey_o_orderpriority_o_orderstatus_o_shippriority_o_totalprice<K3::base_string,
            K3::base_string, int, K3::base_string, int, K3::base_string, K3::base_string, int,
            double>& o) mutable  {
              return o.o_custkey;
            };
          }), 0)).groupBy(std::move([this] (const R_key_value<int, int>& v) mutable  {
            return index_by_hash(std::move(v.key));
          }), std::move([this] (_Collection<R_key_value<int, int>> acc) mutable  {
            return [this, acc = std::move(acc)] (const R_key_value<int, int>& v) mutable  {
              acc.insert(std::move(v));
              return std::move(acc);
            };
          ...
          int>>>& v) mutable  {
            ...
            if (__2) {
              ...
              auto d = std::make_shared<K3::ValDispatcher<_Collection<R_key_value<int,
              int>>>>(v.value);
              __engine.send(p.addr, __lo_probe_rhs_tid, d);
              return unit_t {};
            } else {
              return error<unit_t>(unit_t {});
            }
          ...
          return ignore(std::move(peers.iterate(std::move([this] (const R_addr<Address>& p) mutable  {
            auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
            __engine.send(p.addr, __lo_rhs_peer_barrier_tid, d);
            return unit_t {};
          }))));
        } else {
          return unit_t {};
      ...
      unit_t load_all(unit_t _)  {
        {
          ...
          start = now_int(unit_t {});
          {
            ...
            customerFiles.iterate(std::move([this] (R_path<K3::base_string> e) mutable  {
              return customerLoader(std::move(e.path), customer);
            }));
            supplierFiles.iterate(std::move([this] (R_path<K3::base_string> e) mutable  {
              return supplierLoader(std::move(e.path), supplier);
            }));
            nationFiles.iterate(std::move([this] (R_path<K3::base_string> e) mutable  {
              return nationLoader(std::move(e.path), nation);
            }));
            result = regionFiles.iterate(std::move([this] (R_path<K3::base_string> e) mutable  {
              return regionLoader(std::move(e.path), region);
            }));
            {
              int end;
              end = now_int(unit_t {});
      ...
      unit_t loc_build_lhs(const _Collection<R_key_value<int, _Collection<R_l_epd_l_suppkey<double,
      int>>>>& vals)  {
        return vals.iterate(std::move([this] (const R_key_value<int,
        _Collection<R_l_epd_l_suppkey<double, int>>>& li) mutable  {
          return loc_build.insert_with(std::move(li), std::bind(&__global_context::merge_lior_cse_by_ck_r, std::ref(*this), std::placeholders::_1));
        }));
      }
      unit_t loc_global_barrier(unit_t _)  {
        ...
        if (loc_join_done_cnt == peers.size(unit_t {})) {
          print("Hash join done.");
          print("LI-OR-CS join all nodes finished.");
          auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
          __engine.send(master, __q5_locs_start_tid, d);
          return unit_t {};
        } else {
          return unit_t {};
        }
      ...
      unit_t loc_lhs_scan(unit_t _)  {
        (lior_cse_by_ck.groupBy(std::move([this] (const R_key_value<int,
        _Collection<R_l_epd_l_suppkey<double, int>>>& v) mutable  {
          return index_by_hash(std::move(v.key));
        }), std::move([this] (_Collection<R_key_value<int, _Collection<R_l_epd_l_suppkey<double,
        int>>>> acc) mutable  {
      ...
      unit_t loc_probe_rhs(const _Collection<R_key_value<int, int>>& vals)  {
        return vals.iterate(std::move([this] (const R_key_value<int, int>& c) mutable  {
          shared_ptr<R_key_value<int, _Collection<R_l_epd_l_suppkey<double, int>>>> __4;
          __4 = loc_build.lookup(R_key_value<int, _Collection<R_l_epd_l_suppkey<double,
          int>>> {c.key, _Collection<R_l_epd_l_suppkey<double, int>> {}});
          if (__4) {
            auto& lo = *(__4);
            return ((lo.value).groupBy(std::move([this, &c] (const R_l_epd_l_suppkey<double,
            int>& lo_r) mutable  {
              return R_s_nationkey_s_suppkey<int, int> {c.value, lo_r.l_suppkey};
            }), std::move([this] (const double& acc) mutable  {
              return [this, &acc] (const R_l_epd_l_suppkey<double, int>& lo_r) mutable  {
                return acc + (lo_r.l_epd);
              };
            }), 0.0)).iterate(std::move([this] (const R_key_value<R_s_nationkey_s_suppkey<int, int>,
            double>& kv) mutable  {
              return loc_epd_by_sn.insert_with(std::move(kv), std::bind(&__global_context::merge_epd_by_sn_r, std::ref(*this), std::placeholders::_1));
            }));
          } else {
            return unit_t {};
          }
      ...
      unit_t loc_rhs_scan(unit_t _)  {
        ...
        if (loc_lhs_done_cnt == peers.size(unit_t {})) {
          ((customer.fold(std::move([this] (_Collection<R_key_value<int, int>> acc) mutable  {
            return [this,
            ...
            K3::base_string>& c) mutable  {
              acc.insert(R_key_value<int, int> {c.c_custkey, c.c_nationkey});
              return std::move(acc);
            };
          }), _Collection<R_key_value<int,
          int>> {})).groupBy(std::move([this] (const R_key_value<int, int>& v) mutable  {
            return index_by_hash(std::move(v.key));
          }), std::move([this] (_Collection<R_key_value<int, int>> acc) mutable  {
            return [this, acc = std::move(acc)] (const R_key_value<int, int>& v) mutable  {
              acc.insert(std::move(v));
          ...
          int>> {})).iterate(std::move([this] (const R_key_value<int, _Collection<R_key_value<int,
          int>>>& v) mutable  {
            shared_ptr<R_addr<Address>> __5;
            __5 = peers.at(std::move(v.key));
            if (__5) {
              auto& p = *(__5);
              auto d = std::make_shared<K3::ValDispatcher<_Collection<R_key_value<int,
              int>>>>(v.value);
      ...
      unit_t locs_build_lhs(const _Collection<R_key_value<R_s_nationkey_s_suppkey<int, int>,
      double>>& vals)  {
        return vals.iterate(std::move([this] (const R_key_value<R_s_nationkey_s_suppkey<int, int>,
        double>& epd_by_sn) mutable  {
          return locs_build.insert_with(std::move(epd_by_sn), std::bind(&__global_context::merge_epd_by_sn_r, std::ref(*this), std::placeholders::_1));
        }));
      }
      unit_t locs_global_barrier(unit_t _)  {
        locs_join_done_cnt = locs_join_done_cnt + (1);
        if (locs_join_done_cnt == peers.size(unit_t {})) {
          print("Hash join done.");
          print("LI-OR-CS-SUP join all nodes finished.");
          auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
          __engine.send(master, __q5_locsn_start_tid, d);
          return unit_t {};
        } else {
          return unit_t {};
        }
      }
      unit_t locs_lhs_peer_barrier(unit_t _)  {
        print("Hash join LHS finished build.");
        locs_peer_build_done_cnt = locs_peer_build_done_cnt + (1);
        if (locs_peer_build_done_cnt == peers.size(unit_t {})) {
          return peers.iterate(std::move([this] (const R_addr<Address>& p) mutable  {
            auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
            __engine.send(p.addr, __locs_rhs_scan_tid, d);
            return unit_t {};
          }));
        } else {
          return unit_t {};
      ...
      unit_t locs_lhs_scan(unit_t _)  {
        (loc_epd_by_sn.groupBy(std::move([this] (const R_key_value<R_s_nationkey_s_suppkey<int,
        int>, double>& v) mutable  {
          return index_by_hash(std::move(v.key));
        }), std::move([this] (_Collection<R_key_value<R_s_nationkey_s_suppkey<int, int>,
        double>> acc) mutable  {
          return [this, acc = std::move(acc)] (const R_key_value<R_s_nationkey_s_suppkey<int, int>,
          double>& v) mutable  {
            acc.insert(std::move(v));
            return std::move(acc);
          };
        }), _Collection<R_key_value<R_s_nationkey_s_suppkey<int, int>,
        double>> {})).iterate(std::move([this] (const R_key_value<int,
        _Collection<R_key_value<R_s_nationkey_s_suppkey<int, int>, double>>>& v) mutable  {
          shared_ptr<R_addr<Address>> __6;
          __6 = peers.at(std::move(v.key));
          if (__6) {
            auto& p = *(__6);
            auto d = std::make_shared<K3::ValDispatcher<_Collection<R_key_value<R_s_nationkey_s_suppkey<int,
            int>, double>>>>(v.value);
            __engine.send(p.addr, __locs_build_lhs_tid, d);
            return unit_t {};
          } else {
            return error<unit_t>(unit_t {});
          }
        ...
        return ignore(std::move(peers.iterate(std::move([this] (const R_addr<Address>& p) mutable  {
          auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
          __engine.send(p.addr, __locs_lhs_peer_barrier_tid, d);
          return unit_t {};
        }))));
      }
      unit_t locs_probe_rhs(const _Collection<R_key_value<int, int>>& vals)  {
        return vals.iterate(std::move([this] (const R_key_value<int, int>& s) mutable  {
          shared_ptr<R_key_value<R_s_nationkey_s_suppkey<int, int>, double>> __7;
          __7 = locs_build.lookup(R_key_value<R_s_nationkey_s_suppkey<int, int>,
          double> {R_s_nationkey_s_suppkey<int, int> {s.value, s.key}, 0.0});
          if (__7) {
            auto& loc = *(__7);
            return locs_epd_by_nk.insert_with(R_key_value<int, double> {(loc.key).s_nationkey,
            loc.value}, std::bind(&__global_context::merge_epd_by_nk_r, std::ref(*this), std::placeholders::_1));
          } else {
            return unit_t {};
          }
        }));
      }
      unit_t locs_rhs_peer_barrier(unit_t _)  {
        locs_rhs_done_cnt = locs_rhs_done_cnt + (1);
        if (locs_rhs_done_cnt == peers.size(unit_t {})) {
          print("Hash join RHS finished probe.");
          print("LI-OR-CS-SUP join finished supplier probe.");
          auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
          __engine.send(master, __locs_global_barrier_tid, d);
          return unit_t {};
        } else {
          return unit_t {};
        }
      }
      unit_t locs_rhs_scan(unit_t _)  {
        locs_lhs_done_cnt = locs_lhs_done_cnt + (1);
        if (locs_lhs_done_cnt == peers.size(unit_t {})) {
          ((supplier.fold(std::move([this] (_Collection<R_key_value<int, int>> acc) mutable  {
            return [this,
            acc = std::move(acc)] (const R_s_acctbal_s_address_s_comments_s_name_s_nationkey_s_phone_s_suppkey<double,
            K3::base_string, K3::base_string, K3::base_string, int, K3::base_string,
            int>& s) mutable  {
              acc.insert(R_key_value<int, int> {s.s_suppkey, s.s_nationkey});
              return std::move(acc);
            };
          }), _Collection<R_key_value<int,
          int>> {})).groupBy(std::move([this] (const R_key_value<int, int>& v) mutable  {
          ...
          int>> {})).iterate(std::move([this] (const R_key_value<int, _Collection<R_key_value<int,
          int>>>& v) mutable  {
            shared_ptr<R_addr<Address>> __8;
            __8 = peers.at(std::move(v.key));
            if (__8) {
              auto& p = *(__8);
              auto d = std::make_shared<K3::ValDispatcher<_Collection<R_key_value<int,
              int>>>>(v.value);
              __engine.send(p.addr, __locs_probe_rhs_tid, d);
              return unit_t {};
            } else {
              return error<unit_t>(unit_t {});
            }
          ...
          return ignore(std::move(peers.iterate(std::move([this] (const R_addr<Address>& p) mutable  {
            auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
            __engine.send(p.addr, __locs_rhs_peer_barrier_tid, d);
            return unit_t {};
          }))));
        } else {
          return unit_t {};
      ...
      unit_t locsn_build_lhs(const _Collection<R_key_value<int, double>>& vals)  {
        return vals.iterate(std::move([this] (const R_key_value<int, double>& epd_by_nk) mutable  {
          return locsn_build.insert_with(std::move(epd_by_nk), std::bind(&__global_context::merge_epd_by_nk_r, std::ref(*this), std::placeholders::_1));
        }));
      }
      unit_t locsn_global_barrier(unit_t _)  {
        locsn_join_done_cnt = locsn_join_done_cnt + (1);
        if (locsn_join_done_cnt == peers.size(unit_t {})) {
          print("Hash join done.");
          print("LI-OR-CS-SUP-NT join all nodes finished.");
          auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
          __engine.send(master, __q5_locsnr_start_tid, d);
          return unit_t {};
        } else {
          return unit_t {};
        }
      }
      unit_t locsn_lhs_peer_barrier(unit_t _)  {
        print("Hash join LHS finished build.");
        locsn_peer_build_done_cnt = locsn_peer_build_done_cnt + (1);
        if (locsn_peer_build_done_cnt == peers.size(unit_t {})) {
          return peers.iterate(std::move([this] (const R_addr<Address>& p) mutable  {
            auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
            __engine.send(p.addr, __locsn_rhs_scan_tid, d);
            return unit_t {};
          }));
        } else {
          return unit_t {};
      ...
      unit_t locsn_lhs_scan(unit_t _)  {
        (locs_epd_by_nk.groupBy(std::move([this] (const R_key_value<int, double>& v) mutable  {
          return index_by_hash(std::move(v.key));
        ...
        double>>>& v) mutable  {
          shared_ptr<R_addr<Address>> __9;
          __9 = peers.at(std::move(v.key));
          if (__9) {
            auto& p = *(__9);
            auto d = std::make_shared<K3::ValDispatcher<_Collection<R_key_value<int,
            double>>>>(v.value);
            __engine.send(p.addr, __locsn_build_lhs_tid, d);
            return unit_t {};
          } else {
            return error<unit_t>(unit_t {});
          }
        ...
        return ignore(std::move(peers.iterate(std::move([this] (const R_addr<Address>& p) mutable  {
          auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
          __engine.send(p.addr, __locsn_lhs_peer_barrier_tid, d);
          return unit_t {};
        }))));
      }
      unit_t locsn_probe_rhs(const _Collection<R_key_value<int,
      R_n_name_n_regionkey<K3::base_string, int>>>& vals)  {
        return vals.iterate(std::move([this] (const R_key_value<int,
        R_n_name_n_regionkey<K3::base_string, int>>& n) mutable  {
          shared_ptr<R_key_value<int, double>> __10;
          __10 = locsn_build.lookup(R_key_value<int, double> {n.key, 0.0});
          if (__10) {
            auto& locs = *(__10);
            _Map<R_key_value<K3::base_string, double>> __11;
            {
              _Map<R_key_value<K3::base_string, double>> __collection;
              __collection = _Map<R_key_value<K3::base_string, double>> {};
              __collection.insert(R_key_value<K3::base_string, double> {(n.value).n_name,
              locs.value});
              __11 = __collection;
            }
            return locsn_nepd_by_rk.insert_with(R_key_value<int, _Map<R_key_value<K3::base_string,
            double>>> {(n.value).n_regionkey, __11}, std::bind(&__global_context::merge_nepd_by_rk_r, std::ref(*this), std::placeholders::_1));
          } else {
            return unit_t {};
          }
        }));
      }
      unit_t locsn_rhs_peer_barrier(unit_t _)  {
        locsn_rhs_done_cnt = locsn_rhs_done_cnt + (1);
        if (locsn_rhs_done_cnt == peers.size(unit_t {})) {
          print("Hash join RHS finished probe.");
          print("LI-OR-CS-SUP-NT join finished nation probe.");
          auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
          __engine.send(master, __locsn_global_barrier_tid, d);
          return unit_t {};
        } else {
          return unit_t {};
        }
      }
      unit_t locsn_rhs_scan(unit_t _)  {
        locsn_lhs_done_cnt = locsn_lhs_done_cnt + (1);
        if (locsn_lhs_done_cnt == peers.size(unit_t {})) {
          ((nation.fold(std::move([this] (_Collection<R_key_value<int,
          R_n_name_n_regionkey<K3::base_string, int>>> acc) mutable  {
            return [this,
            acc = std::move(acc)] (const R_n_comments_n_name_n_nationkey_n_regionkey<K3::base_string,
            K3::base_string, int, int>& n) mutable  {
              acc.insert(R_key_value<int, R_n_name_n_regionkey<K3::base_string,
              int>> {n.n_nationkey, R_n_name_n_regionkey<K3::base_string, int> {n.n_name,
              n.n_regionkey}});
              return std::move(acc);
            };
          }), _Collection<R_key_value<int, R_n_name_n_regionkey<K3::base_string,
          int>>> {})).groupBy(std::move([this] (const R_key_value<int,
          R_n_name_n_regionkey<K3::base_string, int>>& v) mutable  {
            return index_by_hash(std::move(v.key));
          }), std::move([this] (_Collection<R_key_value<int, R_n_name_n_regionkey<K3::base_string,
          int>>> acc) mutable  {
            return [this, acc = std::move(acc)] (const R_key_value<int,
            R_n_name_n_regionkey<K3::base_string, int>>& v) mutable  {
              acc.insert(std::move(v));
          ...
          int>>> {})).iterate(std::move([this] (const R_key_value<int, _Collection<R_key_value<int,
          R_n_name_n_regionkey<K3::base_string, int>>>>& v) mutable  {
            shared_ptr<R_addr<Address>> __12;
            __12 = peers.at(std::move(v.key));
            if (__12) {
              auto& p = *(__12);
              auto d = std::make_shared<K3::ValDispatcher<_Collection<R_key_value<int,
              R_n_name_n_regionkey<K3::base_string, int>>>>>(v.value);
              __engine.send(p.addr, __locsn_probe_rhs_tid, d);
              return unit_t {};
            } else {
              return error<unit_t>(unit_t {});
            }
          ...
          return ignore(std::move(peers.iterate(std::move([this] (const R_addr<Address>& p) mutable  {
            auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
            __engine.send(p.addr, __locsn_rhs_peer_barrier_tid, d);
            return unit_t {};
          }))));
        } else {
          return unit_t {};
      ...
      unit_t locsnr_build_lhs(const _Collection<R_key_value<int, _Map<R_key_value<K3::base_string,
      double>>>>& vals)  {
        return vals.iterate(std::move([this] (const R_key_value<int,
        _Map<R_key_value<K3::base_string, double>>>& nepd_by_rk) mutable  {
          return locsnr_build.insert_with(std::move(nepd_by_rk), std::bind(&__global_context::merge_nepd_by_rk_r, std::ref(*this), std::placeholders::_1));
        }));
      }
      unit_t locsnr_global_barrier(unit_t _)  {
        locsnr_join_done_cnt = locsnr_join_done_cnt + (1);
        if (locsnr_join_done_cnt == peers.size(unit_t {})) {
          print("Hash join done.");
          return print("LI-OR-CS-SUP-NT-RG join all nodes finished.");
        } else {
          return unit_t {};
        }
      }
      unit_t locsnr_lhs_peer_barrier(unit_t _)  {
        print("Hash join LHS finished build.");
        locsnr_peer_build_done_cnt = locsnr_peer_build_done_cnt + (1);
        if (locsnr_peer_build_done_cnt == peers.size(unit_t {})) {
          return peers.iterate(std::move([this] (const R_addr<Address>& p) mutable  {
            auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
            __engine.send(p.addr, __locsnr_rhs_scan_tid, d);
            return unit_t {};
          }));
        } else {
          return unit_t {};
      ...
      unit_t locsnr_lhs_scan(unit_t _)  {
        (locsn_nepd_by_rk.groupBy(std::move([this] (const R_key_value<int,
        _Map<R_key_value<K3::base_string, double>>>& v) mutable  {
          return index_by_hash(std::move(v.key));
        }), std::move([this] (_Collection<R_key_value<int, _Map<R_key_value<K3::base_string,
        double>>>> acc) mutable  {
          return [this, acc = std::move(acc)] (const R_key_value<int,
          _Map<R_key_value<K3::base_string, double>>>& v) mutable  {
            acc.insert(std::move(v));
        ...
        }), _Collection<R_key_value<int, _Map<R_key_value<K3::base_string,
        double>>>> {})).iterate(std::move([this] (const R_key_value<int,
        _Collection<R_key_value<int, _Map<R_key_value<K3::base_string, double>>>>>& v) mutable  {
          shared_ptr<R_addr<Address>> __13;
          __13 = peers.at(std::move(v.key));
          if (__13) {
            auto& p = *(__13);
            auto d = std::make_shared<K3::ValDispatcher<_Collection<R_key_value<int,
            _Map<R_key_value<K3::base_string, double>>>>>>(v.value);
            __engine.send(p.addr, __locsnr_build_lhs_tid, d);
            return unit_t {};
          } else {
            return error<unit_t>(unit_t {});
          }
        ...
        return ignore(std::move(peers.iterate(std::move([this] (const R_addr<Address>& p) mutable  {
          auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
          __engine.send(p.addr, __locsnr_lhs_peer_barrier_tid, d);
          return unit_t {};
        }))));
      }
      unit_t locsnr_probe_rhs(const _Collection<R_key_value<int, unit_t>>& vals)  {
        return vals.iterate(std::move([this] (const R_key_value<int, unit_t>& r) mutable  {
          shared_ptr<R_key_value<int, _Map<R_key_value<K3::base_string, double>>>> __14;
          __14 = locsnr_build.lookup(R_key_value<int, _Map<R_key_value<K3::base_string,
          double>>> {r.key, _Map<R_key_value<K3::base_string, double>> {}});
          if (__14) {
            auto& locsn = *(__14);
            return (locsn.value).iterate(std::move([this] (const R_key_value<K3::base_string,
            double>& kv) mutable  {
              return locsnr_epd_by_n.insert_with(std::move(kv), std::bind(&__global_context::merge_nepd_r, std::ref(*this), std::placeholders::_1));
            }));
          } else {
            return unit_t {};
          }
      ...
      unit_t locsnr_rhs_peer_barrier(unit_t _)  {
        locsnr_rhs_done_cnt = locsnr_rhs_done_cnt + (1);
        if (locsnr_rhs_done_cnt == peers.size(unit_t {})) {
          print("Hash join RHS finished probe.");
          print("LI-OR-CS-SUP-NT-RG join finished region probe.");
          auto d = std::make_shared<K3::ValDispatcher<_Map<R_key_value<K3::base_string,
          double>>>>(locsnr_epd_by_n);
          __engine.send(master, __q5_result_aggregate_tid, d);
          auto d2 = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
          __engine.send(master, __finished_tid, d2);
          auto d3 = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
          __engine.send(master, __locsnr_global_barrier_tid, d3);
          return unit_t {};
        } else {
          return unit_t {};
        }
      }
      unit_t locsnr_rhs_scan(unit_t _)  {
        locsnr_lhs_done_cnt = locsnr_lhs_done_cnt + (1);
        if (locsnr_lhs_done_cnt == peers.size(unit_t {})) {
          (((region.filter(std::move([this] (const R_r_comments_r_name_r_regionkey<K3::base_string,
          K3::base_string, int>& r) mutable  {
            return (r.r_name) == ("ASIA");
          }))).fold(std::move([this] (_Collection<R_key_value<int, unit_t>> acc) mutable  {
            return [this,
            acc = std::move(acc)] (const R_r_comments_r_name_r_regionkey<K3::base_string,
            K3::base_string, int>& r) mutable  {
              acc.insert(R_key_value<int, unit_t> {r.r_regionkey, unit_t {}});
              return std::move(acc);
            };
          }), _Collection<R_key_value<int,
          unit_t>> {})).groupBy(std::move([this] (const R_key_value<int, unit_t>& v) mutable  {
            return index_by_hash(std::move(v.key));
          }), std::move([this] (_Collection<R_key_value<int, unit_t>> acc) mutable  {
            return [this, acc = std::move(acc)] (const R_key_value<int, unit_t>& v) mutable  {
              acc.insert(std::move(v));
              return std::move(acc);
            };
          }), _Collection<R_key_value<int,
          unit_t>> {})).iterate(std::move([this] (const R_key_value<int,
          _Collection<R_key_value<int, unit_t>>>& v) mutable  {
            shared_ptr<R_addr<Address>> __15;
            __15 = peers.at(std::move(v.key));
            if (__15) {
              auto& p = *(__15);
              auto d = std::make_shared<K3::ValDispatcher<_Collection<R_key_value<int,
              unit_t>>>>(v.value);
              __engine.send(p.addr, __locsnr_probe_rhs_tid, d);
              return unit_t {};
            } else {
              return error<unit_t>(unit_t {});
            }
          ...
          return ignore(std::move(peers.iterate(std::move([this] (const R_addr<Address>& p) mutable  {
            auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
            __engine.send(p.addr, __locsnr_rhs_peer_barrier_tid, d);
            return unit_t {};
          }))));
        } else {
          return unit_t {};
      ...
      unit_t ready(unit_t _)  {
        ...
        if (nodes_ready_cnt == peers.size(unit_t {})) {
          ...
          auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
          __engine.send(me, __q5_lo_start_tid, d);
          return unit_t {};
        } else {
          return unit_t {};
        }
      ...
      int lo_join_done_cnt;
      bool __lo_join_done_cnt_set__ = false;
      int lo_lhs_done_cnt;
      bool __lo_lhs_done_cnt_set__ = false;
      int lo_peer_build_done_cnt;
      bool __lo_peer_build_done_cnt_set__ = false;
      int lo_rhs_done_cnt;
      bool __lo_rhs_done_cnt_set__ = false;
      ...
      int locs_join_done_cnt;
      bool __locs_join_done_cnt_set__ = false;
      int locs_lhs_done_cnt;
      bool __locs_lhs_done_cnt_set__ = false;
      int locs_peer_build_done_cnt;
      bool __locs_peer_build_done_cnt_set__ = false;
      int locs_rhs_done_cnt;
      bool __locs_rhs_done_cnt_set__ = false;
      int locsn_join_done_cnt;
      bool __locsn_join_done_cnt_set__ = false;
      int locsn_lhs_done_cnt;
      bool __locsn_lhs_done_cnt_set__ = false;
      int locsn_peer_build_done_cnt;
      bool __locsn_peer_build_done_cnt_set__ = false;
      int locsn_rhs_done_cnt;
      bool __locsn_rhs_done_cnt_set__ = false;
      int locsnr_join_done_cnt;
      bool __locsnr_join_done_cnt_set__ = false;
      int locsnr_lhs_done_cnt;
      bool __locsnr_lhs_done_cnt_set__ = false;
      int locsnr_peer_build_done_cnt;
      bool __locsnr_peer_build_done_cnt_set__ = false;
      int locsnr_rhs_done_cnt;
      bool __locsnr_rhs_done_cnt_set__ = false;
      int nodes_ready_cnt;
      ...
      unit_t initDecls(unit_t _)  {
        ...
        if (!(__lo_join_done_cnt_set__)) {
          lo_join_done_cnt = 0;
          __lo_join_done_cnt_set__ = true;
        }
        if (!(__lo_lhs_done_cnt_set__)) {
          lo_lhs_done_cnt = 0;
          __lo_lhs_done_cnt_set__ = true;
        }
        if (!(__lo_peer_build_done_cnt_set__)) {
          lo_peer_build_done_cnt = 0;
          __lo_peer_build_done_cnt_set__ = true;
        }
        if (!(__lo_rhs_done_cnt_set__)) {
          lo_rhs_done_cnt = 0;
          __lo_rhs_done_cnt_set__ = true;
        }
        ...
        if (!(__locs_join_done_cnt_set__)) {
          locs_join_done_cnt = 0;
          __locs_join_done_cnt_set__ = true;
        }
        if (!(__locs_lhs_done_cnt_set__)) {
          locs_lhs_done_cnt = 0;
          __locs_lhs_done_cnt_set__ = true;
        }
        if (!(__locs_peer_build_done_cnt_set__)) {
          locs_peer_build_done_cnt = 0;
          __locs_peer_build_done_cnt_set__ = true;
        }
        if (!(__locs_rhs_done_cnt_set__)) {
          locs_rhs_done_cnt = 0;
          __locs_rhs_done_cnt_set__ = true;
        }
        if (!(__locsn_join_done_cnt_set__)) {
          locsn_join_done_cnt = 0;
          __locsn_join_done_cnt_set__ = true;
        }
        if (!(__locsn_lhs_done_cnt_set__)) {
          locsn_lhs_done_cnt = 0;
          __locsn_lhs_done_cnt_set__ = true;
        }
        if (!(__locsn_peer_build_done_cnt_set__)) {
          locsn_peer_build_done_cnt = 0;
          __locsn_peer_build_done_cnt_set__ = true;
        }
        if (!(__locsn_rhs_done_cnt_set__)) {
          locsn_rhs_done_cnt = 0;
          __locsn_rhs_done_cnt_set__ = true;
        }
        if (!(__locsnr_join_done_cnt_set__)) {
          locsnr_join_done_cnt = 0;
          __locsnr_join_done_cnt_set__ = true;
        }
        if (!(__locsnr_lhs_done_cnt_set__)) {
          locsnr_lhs_done_cnt = 0;
          __locsnr_lhs_done_cnt_set__ = true;
        }
        if (!(__locsnr_peer_build_done_cnt_set__)) {
          locsnr_peer_build_done_cnt = 0;
          __locsnr_peer_build_done_cnt_set__ = true;
        }
        if (!(__locsnr_rhs_done_cnt_set__)) {
          locsnr_rhs_done_cnt = 0;
          __locsnr_rhs_done_cnt_set__ = true;
        }
      ...
      std::map<std::string, std::string> __prettify()  {
        ...
        result["locsnr_rhs_done_cnt"] = K3::prettify_int(locsnr_rhs_done_cnt);
        result["locsnr_peer_build_done_cnt"] = K3::prettify_int(locsnr_peer_build_done_cnt);
        result["locsnr_lhs_done_cnt"] = K3::prettify_int(locsnr_lhs_done_cnt);
        result["locsnr_join_done_cnt"] = K3::prettify_int(locsnr_join_done_cnt);
        result["locsn_rhs_done_cnt"] = K3::prettify_int(locsn_rhs_done_cnt);
        result["locsn_peer_build_done_cnt"] = K3::prettify_int(locsn_peer_build_done_cnt);
        result["locsn_lhs_done_cnt"] = K3::prettify_int(locsn_lhs_done_cnt);
        result["locsn_join_done_cnt"] = K3::prettify_int(locsn_join_done_cnt);
        result["locs_rhs_done_cnt"] = K3::prettify_int(locs_rhs_done_cnt);
        result["locs_peer_build_done_cnt"] = K3::prettify_int(locs_peer_build_done_cnt);
        result["locs_lhs_done_cnt"] = K3::prettify_int(locs_lhs_done_cnt);
        result["locs_join_done_cnt"] = K3::prettify_int(locs_join_done_cnt);
        ...
        result["lo_rhs_done_cnt"] = K3::prettify_int(lo_rhs_done_cnt);
        result["lo_peer_build_done_cnt"] = K3::prettify_int(lo_peer_build_done_cnt);
        result["lo_lhs_done_cnt"] = K3::prettify_int(lo_lhs_done_cnt);
        result["lo_join_done_cnt"] = K3::prettify_int(lo_join_done_cnt);
        ...
        result["locsnr_epd_by_n"] = K3::prettify_collection(locsnr_epd_by_n,
        [] (R_key_value<K3::base_string, double> x)   {
          return K3::prettify_record(x, [] (R_key_value<K3::base_string, double> x)   {
            ostringstream oss;
            oss << ("{");
        ...
        result["locsnr_build"] = K3::prettify_collection(locsnr_build, [] (R_key_value<int,
        _Map<R_key_value<K3::base_string, double>>> x)   {
        ...
        result["locsn_nepd_by_rk"] = K3::prettify_collection(locsn_nepd_by_rk, [] (R_key_value<int,
        _Map<R_key_value<K3::base_string, double>>> x)   {
          return K3::prettify_record(x, [] (R_key_value<int, _Map<R_key_value<K3::base_string,
          double>>> x)   {
            ostringstream oss;
        ...
        result["locsn_build"] = K3::prettify_collection(locsn_build, [] (R_key_value<int,
        double> x)   {
        ...
        result["locs_epd_by_nk"] = K3::prettify_collection(locs_epd_by_nk, [] (R_key_value<int,
        double> x)   {
          return K3::prettify_record(x, [] (R_key_value<int, double> x)   {
            ostringstream oss;
            oss << ("{");
        ...
        result["locs_build"] = K3::prettify_collection(locs_build,
        [] (R_key_value<R_s_nationkey_s_suppkey<int, int>, double> x)   {
          return K3::prettify_record(x, [] (R_key_value<R_s_nationkey_s_suppkey<int, int>,
          double> x)   {
            ostringstream oss;
            oss << ("{");
            oss << std::string("key:") << K3::prettify_record(x.key,
            [] (R_s_nationkey_s_suppkey<int, int> x)   {
              ostringstream oss;
              oss << ("{");
              oss << std::string("s_suppkey:") << K3::prettify_int(x.s_suppkey);
              oss << (",");
              oss << std::string("s_nationkey:") << K3::prettify_int(x.s_nationkey);
              oss << ("}");
              return string_impl(oss.str());
            });
            oss << (",");
        ...
        result["loc_epd_by_sn"] = K3::prettify_collection(loc_epd_by_sn,
        [] (R_key_value<R_s_nationkey_s_suppkey<int, int>, double> x)   {
          return K3::prettify_record(x, [] (R_key_value<R_s_nationkey_s_suppkey<int, int>,
          double> x)   {
            ostringstream oss;
        ...
        _Collection<R_l_epd_l_suppkey<double, int>>> x)   {
          return K3::prettify_record(x, [] (R_key_value<int, _Collection<R_l_epd_l_suppkey<double,
          int>>> x)   {
            ostringstream oss;
            oss << ("{");
            oss << std::string("key:") << K3::prettify_int(x.key);
            oss << (",");
            oss << std::string("value:") << K3::prettify_collection(x.value,
            [] (R_l_epd_l_suppkey<double, int> x)   {
              return K3::prettify_record(x, [] (R_l_epd_l_suppkey<double, int> x)   {
                ostringstream oss;
                oss << ("{");
                oss << std::string("l_suppkey:") << K3::prettify_int(x.l_suppkey);
                oss << (",");
                oss << std::string("l_epd:") << K3::prettify_real(x.l_epd);
                oss << ("}");
                return string_impl(oss.str());
              });
            });
        ...
        result["lior_cse_by_ck"] = K3::prettify_collection(lior_cse_by_ck, [] (R_key_value<int,
        _Collection<R_l_epd_l_suppkey<double, int>>> x)   {
          return K3::prettify_record(x, [] (R_key_value<int, _Collection<R_l_epd_l_suppkey<double,
          int>>> x)   {
            ostringstream oss;
        ...
        result["lior_build"] = K3::prettify_collection(lior_build, [] (R_key_value<int,
        _Collection<R_l_epd_l_suppkey<double, int>>> x)   {
          return K3::prettify_record(x, [] (R_key_value<int, _Collection<R_l_epd_l_suppkey<double,
          int>>> x)   {
            ostringstream oss;
        ...
        result["q5_result"] = K3::prettify_collection(q5_result, [] (R_key_value<K3::base_string,
        double> x)   {
          return K3::prettify_record(x, [] (R_key_value<K3::base_string, double> x)   {
            ostringstream oss;
            oss << ("{");
        ...
        result["region"] = K3::prettify_collection(region,
        [] (R_r_comments_r_name_r_regionkey<K3::base_string, K3::base_string, int> x)   {
          return K3::prettify_record(x, [] (R_r_comments_r_name_r_regionkey<K3::base_string,
          K3::base_string, int> x)   {
            ostringstream oss;
            oss << ("{");
            oss << std::string("r_regionkey:") << K3::prettify_int(x.r_regionkey);
            oss << (",");
            oss << std::string("r_name:") << K3::prettify_string(x.r_name);
            oss << (",");
            oss << std::string("r_comments:") << K3::prettify_string(x.r_comments);
            oss << ("}");
            return string_impl(oss.str());
          });
        });
        result["nation"] = K3::prettify_collection(nation,
        [] (R_n_comments_n_name_n_nationkey_n_regionkey<K3::base_string, K3::base_string, int,
        int> x)   {
          ...
          int> x)   {
            ostringstream oss;
            oss << ("{");
            oss << std::string("n_nationkey:") << K3::prettify_int(x.n_nationkey);
            oss << (",");
            oss << std::string("n_name:") << K3::prettify_string(x.n_name);
            oss << (",");
            oss << std::string("n_regionkey:") << K3::prettify_int(x.n_regionkey);
            oss << (",");
            oss << std::string("n_comments:") << K3::prettify_string(x.n_comments);
            oss << ("}");
            return string_impl(oss.str());
          });
        });
        result["supplier"] = K3::prettify_collection(supplier,
        [] (R_s_acctbal_s_address_s_comments_s_name_s_nationkey_s_phone_s_suppkey<double,
        K3::base_string, K3::base_string, K3::base_string, int, K3::base_string, int> x)   {
          return K3::prettify_record(x,
          [] (R_s_acctbal_s_address_s_comments_s_name_s_nationkey_s_phone_s_suppkey<double,
          K3::base_string, K3::base_string, K3::base_string, int, K3::base_string, int> x)   {
            ostringstream oss;
            ...
            oss << std::string("s_suppkey:") << K3::prettify_int(x.s_suppkey);
            oss << (",");
            oss << std::string("s_name:") << K3::prettify_string(x.s_name);
            oss << (",");
            oss << std::string("s_address:") << K3::prettify_string(x.s_address);
            oss << (",");
            oss << std::string("s_nationkey:") << K3::prettify_int(x.s_nationkey);
            oss << (",");
            oss << std::string("s_phone:") << K3::prettify_string(x.s_phone);
            oss << (",");
            oss << std::string("s_acctbal:") << K3::prettify_real(x.s_acctbal);
            oss << (",");
            oss << std::string("s_comments:") << K3::prettify_string(x.s_comments);
            oss << ("}");
            return string_impl(oss.str());
          });
        });
      ...
      void __patch(std::map<std::string, std::string> bindings)  {
        ...
        if (bindings.count("locsnr_rhs_done_cnt") > (0)) {
          do_patch(bindings["locsnr_rhs_done_cnt"], locsnr_rhs_done_cnt);
          __locsnr_rhs_done_cnt_set__ = true;
        }
        if (bindings.count("locsnr_peer_build_done_cnt") > (0)) {
          do_patch(bindings["locsnr_peer_build_done_cnt"], locsnr_peer_build_done_cnt);
          __locsnr_peer_build_done_cnt_set__ = true;
        }
        if (bindings.count("locsnr_lhs_done_cnt") > (0)) {
          do_patch(bindings["locsnr_lhs_done_cnt"], locsnr_lhs_done_cnt);
          __locsnr_lhs_done_cnt_set__ = true;
        }
        if (bindings.count("locsnr_join_done_cnt") > (0)) {
          do_patch(bindings["locsnr_join_done_cnt"], locsnr_join_done_cnt);
          __locsnr_join_done_cnt_set__ = true;
        }
        if (bindings.count("locsn_rhs_done_cnt") > (0)) {
          do_patch(bindings["locsn_rhs_done_cnt"], locsn_rhs_done_cnt);
          __locsn_rhs_done_cnt_set__ = true;
        }
        if (bindings.count("locsn_peer_build_done_cnt") > (0)) {
          do_patch(bindings["locsn_peer_build_done_cnt"], locsn_peer_build_done_cnt);
          __locsn_peer_build_done_cnt_set__ = true;
        }
        if (bindings.count("locsn_lhs_done_cnt") > (0)) {
          do_patch(bindings["locsn_lhs_done_cnt"], locsn_lhs_done_cnt);
          __locsn_lhs_done_cnt_set__ = true;
        }
        if (bindings.count("locsn_join_done_cnt") > (0)) {
          do_patch(bindings["locsn_join_done_cnt"], locsn_join_done_cnt);
          __locsn_join_done_cnt_set__ = true;
        }
        if (bindings.count("locs_rhs_done_cnt") > (0)) {
          do_patch(bindings["locs_rhs_done_cnt"], locs_rhs_done_cnt);
          __locs_rhs_done_cnt_set__ = true;
        }
        if (bindings.count("locs_peer_build_done_cnt") > (0)) {
          do_patch(bindings["locs_peer_build_done_cnt"], locs_peer_build_done_cnt);
          __locs_peer_build_done_cnt_set__ = true;
        }
        if (bindings.count("locs_lhs_done_cnt") > (0)) {
          do_patch(bindings["locs_lhs_done_cnt"], locs_lhs_done_cnt);
          __locs_lhs_done_cnt_set__ = true;
        }
        if (bindings.count("locs_join_done_cnt") > (0)) {
          do_patch(bindings["locs_join_done_cnt"], locs_join_done_cnt);
          __locs_join_done_cnt_set__ = true;
        }
        ...
        if (bindings.count("lo_rhs_done_cnt") > (0)) {
          do_patch(bindings["lo_rhs_done_cnt"], lo_rhs_done_cnt);
          __lo_rhs_done_cnt_set__ = true;
        }
        if (bindings.count("lo_peer_build_done_cnt") > (0)) {
          do_patch(bindings["lo_peer_build_done_cnt"], lo_peer_build_done_cnt);
          __lo_peer_build_done_cnt_set__ = true;
        }
        if (bindings.count("lo_lhs_done_cnt") > (0)) {
          do_patch(bindings["lo_lhs_done_cnt"], lo_lhs_done_cnt);
          __lo_lhs_done_cnt_set__ = true;
        }
        if (bindings.count("lo_join_done_cnt") > (0)) {
          do_patch(bindings["lo_join_done_cnt"], lo_join_done_cnt);
          __lo_join_done_cnt_set__ = true;
        }
        ...
        if (bindings.count("locsnr_epd_by_n") > (0)) {
          do_patch(bindings["locsnr_epd_by_n"], locsnr_epd_by_n);
        }
        if (bindings.count("locsnr_build") > (0)) {
          do_patch(bindings["locsnr_build"], locsnr_build);
        }
        if (bindings.count("locsn_nepd_by_rk") > (0)) {
          do_patch(bindings["locsn_nepd_by_rk"], locsn_nepd_by_rk);
        }
        if (bindings.count("locsn_build") > (0)) {
          do_patch(bindings["locsn_build"], locsn_build);
        }
        if (bindings.count("locs_epd_by_nk") > (0)) {
          do_patch(bindings["locs_epd_by_nk"], locs_epd_by_nk);
        }
        if (bindings.count("locs_build") > (0)) {
          do_patch(bindings["locs_build"], locs_build);
        }
        if (bindings.count("loc_epd_by_sn") > (0)) {
          do_patch(bindings["loc_epd_by_sn"], loc_epd_by_sn);
        }
        if (bindings.count("loc_build") > (0)) {
          do_patch(bindings["loc_build"], loc_build);
        }
        if (bindings.count("lior_cse_by_ck") > (0)) {
          do_patch(bindings["lior_cse_by_ck"], lior_cse_by_ck);
        }
        if (bindings.count("lior_build") > (0)) {
          do_patch(bindings["lior_build"], lior_build);
        }
        if (bindings.count("q5_result") > (0)) {
          do_patch(bindings["q5_result"], q5_result);
        }
        if (bindings.count("region") > (0)) {
          do_patch(bindings["region"], region);
        }
        if (bindings.count("nation") > (0)) {
          do_patch(bindings["nation"], nation);
        }
        if (bindings.count("supplier") > (0)) {
          do_patch(bindings["supplier"], supplier);
        }
...
int __global_context::__q5_lo_start_tid;
int __global_context::__q5_loc_start_tid;
int __global_context::__q5_locs_start_tid;
int __global_context::__q5_locsn_start_tid;
int __global_context::__q5_locsnr_start_tid;
int __global_context::__q5_result_aggregate_tid;
int __global_context::__start_tid;
int __global_context::__finished_tid;
int __global_context::__hello_tid;
int __global_context::__lo_build_lhs_tid;
int __global_context::__lo_global_barrier_tid;
int __global_context::__lo_lhs_peer_barrier_tid;
int __global_context::__lo_lhs_scan_tid;
int __global_context::__lo_probe_rhs_tid;
int __global_context::__lo_rhs_peer_barrier_tid;
int __global_context::__lo_rhs_scan_tid;
...
int __global_context::__locs_build_lhs_tid;
int __global_context::__locs_global_barrier_tid;
int __global_context::__locs_lhs_peer_barrier_tid;
int __global_context::__locs_lhs_scan_tid;
int __global_context::__locs_probe_rhs_tid;
int __global_context::__locs_rhs_peer_barrier_tid;
int __global_context::__locs_rhs_scan_tid;
int __global_context::__locsn_build_lhs_tid;
int __global_context::__locsn_global_barrier_tid;
int __global_context::__locsn_lhs_peer_barrier_tid;
int __global_context::__locsn_lhs_scan_tid;
int __global_context::__locsn_probe_rhs_tid;
int __global_context::__locsn_rhs_peer_barrier_tid;
int __global_context::__locsn_rhs_scan_tid;
int __global_context::__locsnr_build_lhs_tid;
int __global_context::__locsnr_global_barrier_tid;
int __global_context::__locsnr_lhs_peer_barrier_tid;
int __global_context::__locsnr_lhs_scan_tid;
int __global_context::__locsnr_probe_rhs_tid;
int __global_context::__locsnr_rhs_peer_barrier_tid;
int __global_context::__locsnr_rhs_scan_tid;
int __global_context::__ready_tid;
int __global_context::__shutdown_tid;
int main(int argc, char** argv)  {
  __global_context::__q5_lo_start_tid = 0;
  __global_context::__q5_loc_start_tid = 1;
  __global_context::__q5_locs_start_tid = 2;
  __global_context::__q5_locsn_start_tid = 3;
  __global_context::__q5_locsnr_start_tid = 4;
  __global_context::__q5_result_aggregate_tid = 5;
  __global_context::__start_tid = 6;
  __global_context::__finished_tid = 7;
  __global_context::__hello_tid = 8;
  __global_context::__lo_build_lhs_tid = 9;
  __global_context::__lo_global_barrier_tid = 10;
  __global_context::__lo_lhs_peer_barrier_tid = 11;
  __global_context::__lo_lhs_scan_tid = 12;
  __global_context::__lo_probe_rhs_tid = 13;
  __global_context::__lo_rhs_peer_barrier_tid = 14;
  __global_context::__lo_rhs_scan_tid = 15;
  __global_context::__load_all_tid = 16;
  __global_context::__loc_build_lhs_tid = 17;
  __global_context::__loc_global_barrier_tid = 18;
  __global_context::__loc_lhs_peer_barrier_tid = 19;
  __global_context::__loc_lhs_scan_tid = 20;
  __global_context::__loc_probe_rhs_tid = 21;
  __global_context::__loc_rhs_peer_barrier_tid = 22;
  __global_context::__loc_rhs_scan_tid = 23;
  __global_context::__locs_build_lhs_tid = 24;
  __global_context::__locs_global_barrier_tid = 25;
  __global_context::__locs_lhs_peer_barrier_tid = 26;
  __global_context::__locs_lhs_scan_tid = 27;
  __global_context::__locs_probe_rhs_tid = 28;
  __global_context::__locs_rhs_peer_barrier_tid = 29;
  __global_context::__locs_rhs_scan_tid = 30;
  __global_context::__locsn_build_lhs_tid = 31;
  __global_context::__locsn_global_barrier_tid = 32;
  __global_context::__locsn_lhs_peer_barrier_tid = 33;
  __global_context::__locsn_lhs_scan_tid = 34;
  __global_context::__locsn_probe_rhs_tid = 35;
  __global_context::__locsn_rhs_peer_barrier_tid = 36;
  __global_context::__locsn_rhs_scan_tid = 37;
  __global_context::__locsnr_build_lhs_tid = 38;
  __global_context::__locsnr_global_barrier_tid = 39;
  __global_context::__locsnr_lhs_peer_barrier_tid = 40;
  __global_context::__locsnr_lhs_scan_tid = 41;
  __global_context::__locsnr_probe_rhs_tid = 42;
  __global_context::__locsnr_rhs_peer_barrier_tid = 43;
  __global_context::__locsnr_rhs_scan_tid = 44;
  __global_context::__ready_tid = 45;
  __global_context::__shutdown_tid = 46;
  ...
  __k3_context::__trigger_names[__global_context::__locsnr_rhs_scan_tid] = "locsnr_rhs_scan";
  __k3_context::__trigger_names[__global_context::__locsnr_rhs_peer_barrier_tid] = "locsnr_rhs_peer_barrier";
  __k3_context::__trigger_names[__global_context::__locsnr_probe_rhs_tid] = "locsnr_probe_rhs";
  __k3_context::__trigger_names[__global_context::__locsnr_lhs_scan_tid] = "locsnr_lhs_scan";
  __k3_context::__trigger_names[__global_context::__locsnr_lhs_peer_barrier_tid] = "locsnr_lhs_peer_barrier";
  __k3_context::__trigger_names[__global_context::__locsnr_global_barrier_tid] = "locsnr_global_barrier";
  __k3_context::__trigger_names[__global_context::__locsnr_build_lhs_tid] = "locsnr_build_lhs";
  __k3_context::__trigger_names[__global_context::__locsn_rhs_scan_tid] = "locsn_rhs_scan";
  __k3_context::__trigger_names[__global_context::__locsn_rhs_peer_barrier_tid] = "locsn_rhs_peer_barrier";
  __k3_context::__trigger_names[__global_context::__locsn_probe_rhs_tid] = "locsn_probe_rhs";
  __k3_context::__trigger_names[__global_context::__locsn_lhs_scan_tid] = "locsn_lhs_scan";
  __k3_context::__trigger_names[__global_context::__locsn_lhs_peer_barrier_tid] = "locsn_lhs_peer_barrier";
  __k3_context::__trigger_names[__global_context::__locsn_global_barrier_tid] = "locsn_global_barrier";
  __k3_context::__trigger_names[__global_context::__locsn_build_lhs_tid] = "locsn_build_lhs";
  __k3_context::__trigger_names[__global_context::__locs_rhs_scan_tid] = "locs_rhs_scan";
  __k3_context::__trigger_names[__global_context::__locs_rhs_peer_barrier_tid] = "locs_rhs_peer_barrier";
  __k3_context::__trigger_names[__global_context::__locs_probe_rhs_tid] = "locs_probe_rhs";
  __k3_context::__trigger_names[__global_context::__locs_lhs_scan_tid] = "locs_lhs_scan";
  __k3_context::__trigger_names[__global_context::__locs_lhs_peer_barrier_tid] = "locs_lhs_peer_barrier";
  __k3_context::__trigger_names[__global_context::__locs_global_barrier_tid] = "locs_global_barrier";
  __k3_context::__trigger_names[__global_context::__locs_build_lhs_tid] = "locs_build_lhs";
  ...
  __k3_context::__trigger_names[__global_context::__lo_rhs_scan_tid] = "lo_rhs_scan";
  __k3_context::__trigger_names[__global_context::__lo_rhs_peer_barrier_tid] = "lo_rhs_peer_barrier";
  __k3_context::__trigger_names[__global_context::__lo_probe_rhs_tid] = "lo_probe_rhs";
  __k3_context::__trigger_names[__global_context::__lo_lhs_scan_tid] = "lo_lhs_scan";
  __k3_context::__trigger_names[__global_context::__lo_lhs_peer_barrier_tid] = "lo_lhs_peer_barrier";
  __k3_context::__trigger_names[__global_context::__lo_global_barrier_tid] = "lo_global_barrier";
  __k3_context::__trigger_names[__global_context::__lo_build_lhs_tid] = "lo_build_lhs";
  ...
  __k3_context::__trigger_names[__global_context::__q5_result_aggregate_tid] = "q5_result_aggregate";
  __k3_context::__trigger_names[__global_context::__q5_locsnr_start_tid] = "q5_locsnr_start";
  __k3_context::__trigger_names[__global_context::__q5_locsn_start_tid] = "q5_locsn_start";
  __k3_context::__trigger_names[__global_context::__q5_locs_start_tid] = "q5_locs_start";
  __k3_context::__trigger_names[__global_context::__q5_loc_start_tid] = "q5_loc_start";
  __k3_context::__trigger_names[__global_context::__q5_lo_start_tid] = "q5_lo_start";
  ...
  __k3_context::__clonable_dispatchers[__global_context::__locsnr_rhs_scan_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__locsnr_rhs_peer_barrier_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__locsnr_probe_rhs_tid] = make_shared<ValDispatcher<_Collection<R_key_value<int,
  unit_t>>>>();
  __k3_context::__clonable_dispatchers[__global_context::__locsnr_lhs_scan_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__locsnr_lhs_peer_barrier_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__locsnr_global_barrier_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__locsnr_build_lhs_tid] = make_shared<ValDispatcher<_Collection<R_key_value<int,
  _Map<R_key_value<K3::base_string, double>>>>>>();
  __k3_context::__clonable_dispatchers[__global_context::__locsn_rhs_scan_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__locsn_rhs_peer_barrier_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__locsn_probe_rhs_tid] = make_shared<ValDispatcher<_Collection<R_key_value<int,
  R_n_name_n_regionkey<K3::base_string, int>>>>>();
  __k3_context::__clonable_dispatchers[__global_context::__locsn_lhs_scan_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__locsn_lhs_peer_barrier_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__locsn_global_barrier_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__locsn_build_lhs_tid] = make_shared<ValDispatcher<_Collection<R_key_value<int,
  double>>>>();
  __k3_context::__clonable_dispatchers[__global_context::__locs_rhs_scan_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__locs_rhs_peer_barrier_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__locs_probe_rhs_tid] = make_shared<ValDispatcher<_Collection<R_key_value<int,
  int>>>>();
  __k3_context::__clonable_dispatchers[__global_context::__locs_lhs_scan_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__locs_lhs_peer_barrier_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__locs_global_barrier_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__locs_build_lhs_tid] = make_shared<ValDispatcher<_Collection<R_key_value<R_s_nationkey_s_suppkey<int,
  int>, double>>>>();
  ...
  _Collection<R_l_epd_l_suppkey<double, int>>>>>>();
  __k3_context::__clonable_dispatchers[__global_context::__load_all_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__lo_rhs_scan_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__lo_rhs_peer_barrier_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__lo_probe_rhs_tid] = make_shared<ValDispatcher<_Collection<R_key_value<int,
  int>>>>();
  __k3_context::__clonable_dispatchers[__global_context::__lo_lhs_scan_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__lo_lhs_peer_barrier_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__lo_global_barrier_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__lo_build_lhs_tid] = make_shared<ValDispatcher<_Collection<R_key_value<int,
  _Collection<R_l_epd_l_suppkey<double, int>>>>>>();
  ...
  __k3_context::__clonable_dispatchers[__global_context::__q5_result_aggregate_tid] = make_shared<ValDispatcher<_Map<R_key_value<K3::base_string,
  double>>>>();
  __k3_context::__clonable_dispatchers[__global_context::__q5_locsnr_start_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__q5_locsn_start_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__q5_locs_start_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__q5_loc_start_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__q5_lo_start_tid] = make_shared<ValDispatcher<unit_t>>();
  Options opt;
