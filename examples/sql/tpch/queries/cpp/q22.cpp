...
#endif
#ifndef K3_R_c_acctbal_cntrycode_hash_value
#define K3_R_c_acctbal_cntrycode_hash_value
template <class _T0, class _T1>
class R_c_acctbal_cntrycode {
  public:
      R_c_acctbal_cntrycode(): c_acctbal(), cntrycode()  {}
      template <class __T0, class __T1>
      R_c_acctbal_cntrycode(__T0&& _c_acctbal,
      __T1&& _cntrycode): c_acctbal(std::forward<__T0>(_c_acctbal)),
      cntrycode(std::forward<__T1>(_cntrycode))  {}
      bool operator==(const R_c_acctbal_cntrycode<_T0, _T1>& __other) const {
        return c_acctbal == (__other.c_acctbal) && cntrycode == (__other.cntrycode);
      }
      bool operator!=(const R_c_acctbal_cntrycode<_T0, _T1>& __other) const {
        return std::tie(c_acctbal, cntrycode) != std::tie(__other.c_acctbal, __other.cntrycode);
      }
      bool operator<(const R_c_acctbal_cntrycode<_T0, _T1>& __other) const {
        return std::tie(c_acctbal, cntrycode) < std::tie(__other.c_acctbal, __other.cntrycode);
      }
...
namespace K3 {
  template <class _T0, class _T1>
  class patcher<R_c_acctbal_cntrycode<_T0, _T1>> {
    public:
        static void patch(std::string _input, R_c_acctbal_cntrycode<_T0, _T1>& _record)  {
          shallow<string::iterator> _shallow;
          qi::rule<string::iterator,
          qi::space_type> _c_acctbal = (qi::lit("c_acctbal") >> (':') >> _shallow)[([&_record] (std::string _partial)   {
            do_patch(_partial, _record.c_acctbal);
          ...
          qi::rule<string::iterator,
          qi::space_type> _cntrycode = (qi::lit("cntrycode") >> (':') >> _shallow)[([&_record] (std::string _partial)   {
            do_patch(_partial, _record.cntrycode);
          })];
          qi::rule<string::iterator, qi::space_type> _field = _c_acctbal | _cntrycode;
          qi::rule<string::iterator, qi::space_type> _parser = ('{') >> _field % (',') >> ('}');
          qi::phrase_parse(std::begin(_input), std::end(_input), _parser, qi::space);
        }
  };
}
#ifndef K3_R_c_acctbal_cntrycode
#define K3_R_c_acctbal_cntrycode
template <class _T0, class _T1>
std::size_t hash_value(const R_c_acctbal_cntrycode<_T0, _T1>& r)  {
  boost::hash<std::tuple<_T0, _T1>> hasher;
  return hasher(std::tie(r.c_acctbal, r.cntrycode));
}
#endif
#ifndef K3_R_cnt_sum_hash_value
#define K3_R_cnt_sum_hash_value
template <class _T0, class _T1>
class R_cnt_sum {
  public:
      R_cnt_sum(): cnt(), sum()  {}
      template <class __T0, class __T1>
      R_cnt_sum(__T0&& _cnt, __T1&& _sum): cnt(std::forward<__T0>(_cnt)),
      sum(std::forward<__T1>(_sum))  {}
      bool operator==(const R_cnt_sum<_T0, _T1>& __other) const {
        return cnt == (__other.cnt) && sum == (__other.sum);
      }
      bool operator!=(const R_cnt_sum<_T0, _T1>& __other) const {
        return std::tie(cnt, sum) != std::tie(__other.cnt, __other.sum);
      }
      bool operator<(const R_cnt_sum<_T0, _T1>& __other) const {
        return std::tie(cnt, sum) < std::tie(__other.cnt, __other.sum);
      }
...
namespace K3 {
  template <class _T0, class _T1>
  class patcher<R_cnt_sum<_T0, _T1>> {
    public:
        static void patch(std::string _input, R_cnt_sum<_T0, _T1>& _record)  {
          shallow<string::iterator> _shallow;
          qi::rule<string::iterator,
          qi::space_type> _cnt = (qi::lit("cnt") >> (':') >> _shallow)[([&_record] (std::string _partial)   {
            do_patch(_partial, _record.cnt);
          })];
          qi::rule<string::iterator,
          qi::space_type> _sum = (qi::lit("sum") >> (':') >> _shallow)[([&_record] (std::string _partial)   {
            do_patch(_partial, _record.sum);
          })];
          qi::rule<string::iterator, qi::space_type> _field = _cnt | _sum;
          qi::rule<string::iterator, qi::space_type> _parser = ('{') >> _field % (',') >> ('}');
          qi::phrase_parse(std::begin(_input), std::end(_input), _parser, qi::space);
        }
  };
...
#define K3_R_cnt_sum
template <class _T0, class _T1>
std::size_t hash_value(const R_cnt_sum<_T0, _T1>& r)  {
  boost::hash<std::tuple<_T0, _T1>> hasher;
  return hasher(std::tie(r.cnt, r.sum));
}
#endif
...
#endif
#ifndef K3_R_nc_tab_hash_value
#define K3_R_nc_tab_hash_value
template <class _T0, class _T1>
class R_nc_tab {
  public:
      R_nc_tab(): nc(), tab()  {}
      template <class __T0, class __T1>
      R_nc_tab(__T0&& _nc, __T1&& _tab): nc(std::forward<__T0>(_nc)),
      tab(std::forward<__T1>(_tab))  {}
      bool operator==(const R_nc_tab<_T0, _T1>& __other) const {
        return nc == (__other.nc) && tab == (__other.tab);
      }
      bool operator!=(const R_nc_tab<_T0, _T1>& __other) const {
        return std::tie(nc, tab) != std::tie(__other.nc, __other.tab);
      }
      bool operator<(const R_nc_tab<_T0, _T1>& __other) const {
        return std::tie(nc, tab) < std::tie(__other.nc, __other.tab);
      }
...
namespace K3 {
  template <class _T0, class _T1>
  class patcher<R_nc_tab<_T0, _T1>> {
    public:
        static void patch(std::string _input, R_nc_tab<_T0, _T1>& _record)  {
          shallow<string::iterator> _shallow;
          qi::rule<string::iterator,
          qi::space_type> _nc = (qi::lit("nc") >> (':') >> _shallow)[([&_record] (std::string _partial)   {
            do_patch(_partial, _record.nc);
          })];
          qi::rule<string::iterator,
          qi::space_type> _tab = (qi::lit("tab") >> (':') >> _shallow)[([&_record] (std::string _partial)   {
            do_patch(_partial, _record.tab);
          })];
          qi::rule<string::iterator, qi::space_type> _field = _nc | _tab;
          qi::rule<string::iterator, qi::space_type> _parser = ('{') >> _field % (',') >> ('}');
          qi::phrase_parse(std::begin(_input), std::end(_input), _parser, qi::space);
        }
  };
...
#define K3_R_nc_tab
template <class _T0, class _T1>
std::size_t hash_value(const R_nc_tab<_T0, _T1>& r)  {
  boost::hash<std::tuple<_T0, _T1>> hasher;
  return hasher(std::tie(r.nc, r.tab));
}
#endif
...
public K3::__time_context {
  public:
      ...
      K3::__time_context()  {
        ...
        dispatch_table[__co_rhs_scan_tid] = [this] (void* payload)   {
          co_rhs_scan(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__co_rhs_peer_barrier_tid] = [this] (void* payload)   {
          co_rhs_peer_barrier(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__co_probe_rhs_tid] = [this] (void* payload)   {
          co_probe_rhs(*(static_cast<_Collection<R_key_value<int,
          _Collection<R_c_acctbal_cntrycode<double, K3::base_string>>>>*>(payload)));
        };
        dispatch_table[__co_lhs_scan_tid] = [this] (void* payload)   {
          co_lhs_scan(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__co_lhs_peer_barrier_tid] = [this] (void* payload)   {
          co_lhs_peer_barrier(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__co_global_barrier_tid] = [this] (void* payload)   {
          co_global_barrier(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__co_build_lhs_tid] = [this] (void* payload)   {
          co_build_lhs(*(static_cast<_Collection<R_key_value<int, unit_t>>*>(payload)));
        };
        dispatch_table[__start_tid] = [this] (void* payload)   {
          start(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__q22_final_aggregate_tid] = [this] (void* payload)   {
          q22_final_aggregate(*(static_cast<_Map<R_key_value<K3::base_string, R_nc_tab<int,
          double>>>*>(payload)));
        };
        dispatch_table[__customer_subagg_final_tid] = [this] (void* payload)   {
          customer_subagg_final(*(static_cast<R_cnt_sum<int, double>*>(payload)));
        };
        dispatch_table[__customer_subagg_local_tid] = [this] (void* payload)   {
          customer_subagg_local(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__customer_set_avg_acctbal_tid] = [this] (void* payload)   {
          customer_set_avg_acctbal(*(static_cast<double*>(payload)));
        };
        dispatch_table[__customer_subagg_tid] = [this] (void* payload)   {
          customer_subagg(*(static_cast<unit_t*>(payload)));
        };
      }
      static int __customer_subagg_tid;
      static int __customer_set_avg_acctbal_tid;
      static int __customer_subagg_local_tid;
      static int __customer_subagg_final_tid;
      static int __q22_final_aggregate_tid;
      static int __start_tid;
      static int __co_build_lhs_tid;
      static int __co_global_barrier_tid;
      static int __co_lhs_peer_barrier_tid;
      static int __co_lhs_scan_tid;
      static int __co_probe_rhs_tid;
      static int __co_rhs_peer_barrier_tid;
      static int __co_rhs_scan_tid;
      ...
      double>> orders;
      _Map<R_key_value<K3::base_string, unit_t>> c_valid_phone;
      bool __c_valid_phone_set__ = false;
      double c_avg_acctbal;
      R_cnt_sum<int, double> c_acc_acctbal;
      _Map<R_key_value<int, unit_t>> o_ck;
      _Map<R_key_value<K3::base_string, R_nc_tab<int, double>>> c_nt_by_cc;
      _Map<R_key_value<K3::base_string, R_nc_tab<int, double>>> q22_result;
      auto merge_c_nt_by_cc(const R_key_value<K3::base_string, R_nc_tab<int, double>>& a)  {
        return [this, &a] (const R_key_value<K3::base_string, R_nc_tab<int, double>>& b) mutable  {
          return R_key_value<K3::base_string, R_nc_tab<int, double>> {a.key, R_nc_tab<int,
          double> {((a.value).nc) + ((b.value).nc), ((a.value).tab) + ((b.value).tab)}};
        };
      }
      unit_t customer_subagg(unit_t _)  {
        return peers.iterate(std::move([this] (const R_addr<Address>& p) mutable  {
          auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
          __engine.send(p.addr, __customer_subagg_local_tid, d);
          return unit_t {};
        }));
      }
      unit_t customer_set_avg_acctbal(const double& avg_acctbal)  {
        c_avg_acctbal = avg_acctbal;
        return unit_t {};
      }
      unit_t customer_subagg_local(unit_t _)  {
        {
          R_cnt_sum<int, double> c_acctbal_agg;
          c_acctbal_agg = (customer.filter(std::move([this] (R_c_acctbal_c_address_c_comments_c_custkey_c_mktsegment_c_name_c_nationkey_c_phone<double,
          K3::base_string, K3::base_string, int, K3::base_string, K3::base_string, int,
          K3::base_string> c) mutable  {
            shared_ptr<R_key_value<K3::base_string, unit_t>> __0;
            __0 = c_valid_phone.lookup(R_key_value<K3::base_string,
            unit_t> {slice_string(std::move(c.c_phone), 0, 2), unit_t {}});
            if (__0) {
              auto& x = *(__0);
              return (c.c_acctbal) > (0.0);
            } else {
              return false;
            }
          }))).fold(std::move([this] (const R_cnt_sum<int, double>& acc) mutable  {
            return [this,
            &acc] (const R_c_acctbal_c_address_c_comments_c_custkey_c_mktsegment_c_name_c_nationkey_c_phone<double,
            K3::base_string, K3::base_string, int, K3::base_string, K3::base_string, int,
            K3::base_string>& c) mutable  {
              return R_cnt_sum<int, double> {(acc.cnt) + (1), (acc.sum) + (c.c_acctbal)};
            };
          }), R_cnt_sum<int, double> {0, 0.0});
          auto d = std::make_shared<K3::ValDispatcher<R_cnt_sum<int, double>>>(c_acctbal_agg);
          __engine.send(master, __customer_subagg_final_tid, d);
          return unit_t {};
        }
      }
      unit_t customer_subagg_final(const R_cnt_sum<int, double>& partial)  {
        c_acc_acctbal = R_cnt_sum<int, double> {(c_acc_acctbal.cnt) + (partial.cnt),
        (c_acc_acctbal.sum) + (partial.sum)};
        customer_subagg_done_cnt = customer_subagg_done_cnt + (1);
        if (customer_subagg_done_cnt == peers.size(unit_t {})) {
          ...
          peers.iterate(std::move([this] (const R_addr<Address>& p) mutable  {
            auto d = std::make_shared<K3::ValDispatcher<double>>(c_avg_acctbal);
            __engine.send(p.addr, __customer_set_avg_acctbal_tid, d);
            return unit_t {};
          }));
          return peers.iterate(std::move([this] (const R_addr<Address>& p) mutable  {
            auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
            __engine.send(p.addr, __co_lhs_scan_tid, d);
            return unit_t {};
          }));
        } else {
          return unit_t {};
      ...
      unit_t q22_final_aggregate(const _Map<R_key_value<K3::base_string, R_nc_tab<int,
      double>>>& vals)  {
        vals.iterate(std::move([this] (const R_key_value<K3::base_string, R_nc_tab<int,
        double>>& kv) mutable  {
          return q22_result.insert_with(std::move(kv), std::bind(&__global_context::merge_c_nt_by_cc, std::ref(*this), std::placeholders::_1));
        }));
        q22_aggregate_done_cnt = q22_aggregate_done_cnt + (1);
        if (q22_aggregate_done_cnt == peers.size(unit_t {})) {
          return print("Q22 final aggregation done.");
        } else {
          return unit_t {};
        }
      }
      ...
      int customer_subagg_done_cnt;
      bool __customer_subagg_done_cnt_set__ = false;
      ...
      int q22_aggregate_done_cnt;
      bool __q22_aggregate_done_cnt_set__ = false;
      _Collection<R_path<K3::base_string>> regionFiles;
      _Collection<R_path<K3::base_string>> supplierFiles;
      unit_t co_build_lhs(const _Collection<R_key_value<int, unit_t>>& vals)  {
        return vals.iterate(std::move([this] (const R_key_value<int, unit_t>& o) mutable  {
          return o_ck.insert_with(std::move(o), std::move([this] (const R_key_value<int,
          unit_t>& a) mutable  {
            return [this, &a] (R_key_value<int, unit_t> b) mutable  {
              return R_key_value<int, unit_t> {a.key, unit_t {}};
            };
          }));
        }));
      }
      unit_t co_global_barrier(unit_t _)  {
        co_join_done_cnt = co_join_done_cnt + (1);
        if (co_join_done_cnt == peers.size(unit_t {})) {
          print("Hash join done.");
          return print("OR-CS join all nodes finished.");
        } else {
          return unit_t {};
        }
      }
      unit_t co_lhs_peer_barrier(unit_t _)  {
        print("Hash join LHS finished build.");
        co_peer_build_done_cnt = co_peer_build_done_cnt + (1);
        if (co_peer_build_done_cnt == peers.size(unit_t {})) {
          return peers.iterate(std::move([this] (const R_addr<Address>& p) mutable  {
            auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
            __engine.send(p.addr, __co_rhs_scan_tid, d);
            return unit_t {};
          }));
        } else {
          return unit_t {};
      ...
      unit_t co_lhs_scan(unit_t _)  {
        ((orders.groupBy(std::move([this] (const R_o_clerk_o_comments_o_custkey_o_orderdate_o_orderkey_o_orderpriority_o_orderstatus_o_shippriority_o_totalprice<K3::base_string,
        K3::base_string, int, K3::base_string, int, K3::base_string, K3::base_string, int,
        double>& o) mutable  {
          return o.o_custkey;
        }), std::move([this] (const unit_t& acc) mutable  {
          return [this,
          &acc] (R_o_clerk_o_comments_o_custkey_o_orderdate_o_orderkey_o_orderpriority_o_orderstatus_o_shippriority_o_totalprice<K3::base_string,
          K3::base_string, int, K3::base_string, int, K3::base_string, K3::base_string, int,
          double> _) mutable  {
            return std::move(acc);
          };
        ...
        unit_t>> {})).iterate(std::move([this] (const R_key_value<int, _Collection<R_key_value<int,
        unit_t>>>& v) mutable  {
          shared_ptr<R_addr<Address>> __1;
          __1 = peers.at(std::move(v.key));
          if (__1) {
            auto& p = *(__1);
            auto d = std::make_shared<K3::ValDispatcher<_Collection<R_key_value<int,
            unit_t>>>>(v.value);
            __engine.send(p.addr, __co_build_lhs_tid, d);
            return unit_t {};
          } else {
        ...
        return ignore(std::move(peers.iterate(std::move([this] (const R_addr<Address>& p) mutable  {
          auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
          __engine.send(p.addr, __co_lhs_peer_barrier_tid, d);
          return unit_t {};
        }))));
      }
      unit_t co_probe_rhs(const _Collection<R_key_value<int,
      _Collection<R_c_acctbal_cntrycode<double, K3::base_string>>>>& vals)  {
        return vals.iterate(std::move([this] (const R_key_value<int,
        _Collection<R_c_acctbal_cntrycode<double, K3::base_string>>>& c) mutable  {
          shared_ptr<R_key_value<int, unit_t>> __2;
          __2 = o_ck.lookup(R_key_value<int, unit_t> {c.key, unit_t {}});
          if (__2) {
            auto& _ = *(__2);
            return unit_t {};
          } else {
            return (c.value).iterate(std::move([this] (const R_c_acctbal_cntrycode<double,
            K3::base_string>& ca) mutable  {
              return c_nt_by_cc.insert_with(R_key_value<K3::base_string, R_nc_tab<int,
              double>> {ca.cntrycode, R_nc_tab<int, double> {1, ca.c_acctbal}}, std::bind(&__global_context::merge_c_nt_by_cc, std::ref(*this), std::placeholders::_1));
            }));
          }
        }));
      }
      unit_t co_rhs_peer_barrier(unit_t _)  {
        co_rhs_done_cnt = co_rhs_done_cnt + (1);
        if (co_rhs_done_cnt == peers.size(unit_t {})) {
          print("Hash join RHS finished probe.");
          print("OR-CS join finished customer probe.");
          auto d1 = std::make_shared<K3::ValDispatcher<_Map<R_key_value<K3::base_string,
          R_nc_tab<int, double>>>>>(c_nt_by_cc);
          __engine.send(master, __q22_final_aggregate_tid, d1);
          ...
          __engine.send(master, __co_global_barrier_tid, d3);
          return unit_t {};
        } else {
          return unit_t {};
        }
      }
      unit_t co_rhs_scan(unit_t _)  {
        co_lhs_done_cnt = co_lhs_done_cnt + (1);
        if (co_lhs_done_cnt == peers.size(unit_t {})) {
          (((customer.filter(std::move([this] (R_c_acctbal_c_address_c_comments_c_custkey_c_mktsegment_c_name_c_nationkey_c_phone<double,
          K3::base_string, K3::base_string, int, K3::base_string, K3::base_string, int,
          K3::base_string> c) mutable  {
            shared_ptr<R_key_value<K3::base_string, unit_t>> __3;
            __3 = c_valid_phone.lookup(R_key_value<K3::base_string,
            unit_t> {slice_string(std::move(c.c_phone), 0, 2), unit_t {}});
            if (__3) {
              auto& x = *(__3);
              return (c.c_acctbal) > c_avg_acctbal;
            } else {
              return false;
            }
          }))).groupBy(std::move([this] (const R_c_acctbal_c_address_c_comments_c_custkey_c_mktsegment_c_name_c_nationkey_c_phone<double,
          K3::base_string, K3::base_string, int, K3::base_string, K3::base_string, int,
          K3::base_string>& c) mutable  {
            return c.c_custkey;
          }), std::move([this] (_Collection<R_c_acctbal_cntrycode<double,
          K3::base_string>> acc) mutable  {
            return [this,
            acc = std::move(acc)] (R_c_acctbal_c_address_c_comments_c_custkey_c_mktsegment_c_name_c_nationkey_c_phone<double,
            K3::base_string, K3::base_string, int, K3::base_string, K3::base_string, int,
            K3::base_string> c) mutable  {
              acc.insert(R_c_acctbal_cntrycode<double, K3::base_string> {c.c_acctbal,
              slice_string(std::move(c.c_phone), 0, 2)});
              return std::move(acc);
            };
          }), _Collection<R_c_acctbal_cntrycode<double,
          K3::base_string>> {})).groupBy(std::move([this] (const R_key_value<int,
          _Collection<R_c_acctbal_cntrycode<double, K3::base_string>>>& v) mutable  {
            return index_by_hash(std::move(v.key));
          }), std::move([this] (_Collection<R_key_value<int,
          _Collection<R_c_acctbal_cntrycode<double, K3::base_string>>>> acc) mutable  {
            return [this, acc = std::move(acc)] (const R_key_value<int,
            _Collection<R_c_acctbal_cntrycode<double, K3::base_string>>>& v) mutable  {
              acc.insert(std::move(v));
              return std::move(acc);
            };
          }), _Collection<R_key_value<int, _Collection<R_c_acctbal_cntrycode<double,
          ...
          K3::base_string>>>>>& v) mutable  {
            ...
            if (__4) {
              auto& p = *(__4);
              auto d = std::make_shared<K3::ValDispatcher<_Collection<R_key_value<int,
              _Collection<R_c_acctbal_cntrycode<double, K3::base_string>>>>>>(v.value);
              __engine.send(p.addr, __co_probe_rhs_tid, d);
              return unit_t {};
            } else {
              return error<unit_t>(unit_t {});
            }
          ...
          return ignore(std::move(peers.iterate(std::move([this] (const R_addr<Address>& p) mutable  {
            auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
            __engine.send(p.addr, __co_rhs_peer_barrier_tid, d);
            return unit_t {};
          }))));
        } else {
          return unit_t {};
      ...
      unit_t ready(unit_t _)  {
        ...
        if (nodes_ready_cnt == peers.size(unit_t {})) {
          ...
          auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
          __engine.send(me, __customer_subagg_tid, d);
          return unit_t {};
        } else {
          return unit_t {};
        }
      ...
      int co_join_done_cnt;
      bool __co_join_done_cnt_set__ = false;
      int co_lhs_done_cnt;
      bool __co_lhs_done_cnt_set__ = false;
      int co_peer_build_done_cnt;
      bool __co_peer_build_done_cnt_set__ = false;
      int co_rhs_done_cnt;
      bool __co_rhs_done_cnt_set__ = false;
      int nodes_ready_cnt;
      ...
      unit_t initDecls(unit_t _)  {
        if (!(__master_set__)) {
          master = make_address("127.0.0.1", 4000);
          __master_set__ = true;
        }
        if (!(__c_valid_phone_set__)) {
          {
            _Map<R_key_value<K3::base_string, unit_t>> __collection;
            __collection = _Map<R_key_value<K3::base_string, unit_t>> {};
            __collection.insert(R_key_value<K3::base_string, unit_t> {"13", unit_t {}});
            __collection.insert(R_key_value<K3::base_string, unit_t> {"31", unit_t {}});
            __collection.insert(R_key_value<K3::base_string, unit_t> {"23", unit_t {}});
            __collection.insert(R_key_value<K3::base_string, unit_t> {"29", unit_t {}});
            __collection.insert(R_key_value<K3::base_string, unit_t> {"30", unit_t {}});
            __collection.insert(R_key_value<K3::base_string, unit_t> {"18", unit_t {}});
            __collection.insert(R_key_value<K3::base_string, unit_t> {"17", unit_t {}});
            c_valid_phone = __collection;
          }
          __c_valid_phone_set__ = true;
        }
        if (!(__customer_subagg_done_cnt_set__)) {
          customer_subagg_done_cnt = 0;
          __customer_subagg_done_cnt_set__ = true;
        }
        if (!(__q22_aggregate_done_cnt_set__)) {
          q22_aggregate_done_cnt = 0;
          __q22_aggregate_done_cnt_set__ = true;
        }
        if (!(__co_join_done_cnt_set__)) {
          co_join_done_cnt = 0;
          __co_join_done_cnt_set__ = true;
        }
        if (!(__co_lhs_done_cnt_set__)) {
          co_lhs_done_cnt = 0;
          __co_lhs_done_cnt_set__ = true;
        }
        if (!(__co_peer_build_done_cnt_set__)) {
          co_peer_build_done_cnt = 0;
          __co_peer_build_done_cnt_set__ = true;
        }
        if (!(__co_rhs_done_cnt_set__)) {
          co_rhs_done_cnt = 0;
          __co_rhs_done_cnt_set__ = true;
        }
      ...
      std::map<std::string, std::string> __prettify()  {
        ...
        result["co_rhs_done_cnt"] = K3::prettify_int(co_rhs_done_cnt);
        result["co_peer_build_done_cnt"] = K3::prettify_int(co_peer_build_done_cnt);
        result["co_lhs_done_cnt"] = K3::prettify_int(co_lhs_done_cnt);
        result["co_join_done_cnt"] = K3::prettify_int(co_join_done_cnt);
        ...
        result["q22_aggregate_done_cnt"] = K3::prettify_int(q22_aggregate_done_cnt);
        ...
        result["customer_subagg_done_cnt"] = K3::prettify_int(customer_subagg_done_cnt);
        ...
        result["q22_result"] = K3::prettify_collection(q22_result, [] (R_key_value<K3::base_string,
        R_nc_tab<int, double>> x)   {
          return K3::prettify_record(x, [] (R_key_value<K3::base_string, R_nc_tab<int,
          double>> x)   {
            ostringstream oss;
            oss << ("{");
        ...
        result["c_nt_by_cc"] = K3::prettify_collection(c_nt_by_cc, [] (R_key_value<K3::base_string,
        R_nc_tab<int, double>> x)   {
          return K3::prettify_record(x, [] (R_key_value<K3::base_string, R_nc_tab<int,
          double>> x)   {
            ostringstream oss;
        ...
        result["o_ck"] = K3::prettify_collection(o_ck, [] (R_key_value<int, unit_t> x)   {
          return K3::prettify_record(x, [] (R_key_value<int, unit_t> x)   {
            ostringstream oss;
            oss << ("{");
        ...
        result["c_acc_acctbal"] = K3::prettify_record(c_acc_acctbal, [] (R_cnt_sum<int,
        double> x)   {
          ostringstream oss;
          oss << ("{");
        ...
        result["c_avg_acctbal"] = K3::prettify_real(c_avg_acctbal);
        result["c_valid_phone"] = K3::prettify_collection(c_valid_phone,
        [] (R_key_value<K3::base_string, unit_t> x)   {
          return K3::prettify_record(x, [] (R_key_value<K3::base_string, unit_t> x)   {
            ostringstream oss;
            oss << ("{");
            oss << std::string("key:") << K3::prettify_string(x.key);
            oss << (",");
      ...
      void __patch(std::map<std::string, std::string> bindings)  {
        ...
        if (bindings.count("co_rhs_done_cnt") > (0)) {
          do_patch(bindings["co_rhs_done_cnt"], co_rhs_done_cnt);
          __co_rhs_done_cnt_set__ = true;
        }
        if (bindings.count("co_peer_build_done_cnt") > (0)) {
          do_patch(bindings["co_peer_build_done_cnt"], co_peer_build_done_cnt);
          __co_peer_build_done_cnt_set__ = true;
        }
        if (bindings.count("co_lhs_done_cnt") > (0)) {
          do_patch(bindings["co_lhs_done_cnt"], co_lhs_done_cnt);
          __co_lhs_done_cnt_set__ = true;
        }
        if (bindings.count("co_join_done_cnt") > (0)) {
          do_patch(bindings["co_join_done_cnt"], co_join_done_cnt);
          __co_join_done_cnt_set__ = true;
        }
        ...
        if (bindings.count("q22_aggregate_done_cnt") > (0)) {
          do_patch(bindings["q22_aggregate_done_cnt"], q22_aggregate_done_cnt);
          __q22_aggregate_done_cnt_set__ = true;
        }
        ...
        if (bindings.count("customer_subagg_done_cnt") > (0)) {
          do_patch(bindings["customer_subagg_done_cnt"], customer_subagg_done_cnt);
          __customer_subagg_done_cnt_set__ = true;
        }
        if (bindings.count("customerFiles") > (0)) {
          do_patch(bindings["customerFiles"], customerFiles);
        }
        if (bindings.count("q22_result") > (0)) {
          do_patch(bindings["q22_result"], q22_result);
        }
        if (bindings.count("c_nt_by_cc") > (0)) {
          do_patch(bindings["c_nt_by_cc"], c_nt_by_cc);
        }
        if (bindings.count("o_ck") > (0)) {
          do_patch(bindings["o_ck"], o_ck);
        }
        if (bindings.count("c_acc_acctbal") > (0)) {
          do_patch(bindings["c_acc_acctbal"], c_acc_acctbal);
        }
        if (bindings.count("c_avg_acctbal") > (0)) {
          do_patch(bindings["c_avg_acctbal"], c_avg_acctbal);
        }
        if (bindings.count("c_valid_phone") > (0)) {
          do_patch(bindings["c_valid_phone"], c_valid_phone);
          __c_valid_phone_set__ = true;
        }
...
int __global_context::__customer_subagg_tid;
int __global_context::__customer_set_avg_acctbal_tid;
int __global_context::__customer_subagg_local_tid;
int __global_context::__customer_subagg_final_tid;
int __global_context::__q22_final_aggregate_tid;
int __global_context::__start_tid;
int __global_context::__co_build_lhs_tid;
int __global_context::__co_global_barrier_tid;
int __global_context::__co_lhs_peer_barrier_tid;
int __global_context::__co_lhs_scan_tid;
int __global_context::__co_probe_rhs_tid;
int __global_context::__co_rhs_peer_barrier_tid;
int __global_context::__co_rhs_scan_tid;
...
int main(int argc, char** argv)  {
  __global_context::__customer_subagg_tid = 0;
  __global_context::__customer_set_avg_acctbal_tid = 1;
  __global_context::__customer_subagg_local_tid = 2;
  __global_context::__customer_subagg_final_tid = 3;
  __global_context::__q22_final_aggregate_tid = 4;
  __global_context::__start_tid = 5;
  __global_context::__co_build_lhs_tid = 6;
  __global_context::__co_global_barrier_tid = 7;
  __global_context::__co_lhs_peer_barrier_tid = 8;
  __global_context::__co_lhs_scan_tid = 9;
  __global_context::__co_probe_rhs_tid = 10;
  __global_context::__co_rhs_peer_barrier_tid = 11;
  __global_context::__co_rhs_scan_tid = 12;
  __global_context::__finished_tid = 13;
  __global_context::__hello_tid = 14;
  __global_context::__load_all_tid = 15;
  ...
  __k3_context::__trigger_names[__global_context::__co_rhs_scan_tid] = "co_rhs_scan";
  __k3_context::__trigger_names[__global_context::__co_rhs_peer_barrier_tid] = "co_rhs_peer_barrier";
  __k3_context::__trigger_names[__global_context::__co_probe_rhs_tid] = "co_probe_rhs";
  __k3_context::__trigger_names[__global_context::__co_lhs_scan_tid] = "co_lhs_scan";
  __k3_context::__trigger_names[__global_context::__co_lhs_peer_barrier_tid] = "co_lhs_peer_barrier";
  __k3_context::__trigger_names[__global_context::__co_global_barrier_tid] = "co_global_barrier";
  __k3_context::__trigger_names[__global_context::__co_build_lhs_tid] = "co_build_lhs";
  __k3_context::__trigger_names[__global_context::__start_tid] = "start";
  __k3_context::__trigger_names[__global_context::__q22_final_aggregate_tid] = "q22_final_aggregate";
  __k3_context::__trigger_names[__global_context::__customer_subagg_final_tid] = "customer_subagg_final";
  __k3_context::__trigger_names[__global_context::__customer_subagg_local_tid] = "customer_subagg_local";
  __k3_context::__trigger_names[__global_context::__customer_set_avg_acctbal_tid] = "customer_set_avg_acctbal";
  __k3_context::__trigger_names[__global_context::__customer_subagg_tid] = "customer_subagg";
  ...
  __k3_context::__clonable_dispatchers[__global_context::__co_rhs_scan_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__co_rhs_peer_barrier_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__co_probe_rhs_tid] = make_shared<ValDispatcher<_Collection<R_key_value<int,
  _Collection<R_c_acctbal_cntrycode<double, K3::base_string>>>>>>();
  __k3_context::__clonable_dispatchers[__global_context::__co_lhs_scan_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__co_lhs_peer_barrier_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__co_global_barrier_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__co_build_lhs_tid] = make_shared<ValDispatcher<_Collection<R_key_value<int,
  unit_t>>>>();
  __k3_context::__clonable_dispatchers[__global_context::__start_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__q22_final_aggregate_tid] = make_shared<ValDispatcher<_Map<R_key_value<K3::base_string,
  R_nc_tab<int, double>>>>>();
  __k3_context::__clonable_dispatchers[__global_context::__customer_subagg_final_tid] = make_shared<ValDispatcher<R_cnt_sum<int,
  double>>>();
  __k3_context::__clonable_dispatchers[__global_context::__customer_subagg_local_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__customer_set_avg_acctbal_tid] = make_shared<ValDispatcher<double>>();
  __k3_context::__clonable_dispatchers[__global_context::__customer_subagg_tid] = make_shared<ValDispatcher<unit_t>>();
  Options opt;
