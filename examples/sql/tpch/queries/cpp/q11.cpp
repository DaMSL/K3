...
#endif
#ifndef K3_R_nk_hash_value
#define K3_R_nk_hash_value
template <class _T0>
class R_nk {
  public:
      R_nk(): nk()  {}
      R_nk(const _T0& _nk): nk(_nk)  {}
      R_nk(_T0&& _nk): nk(std::move(_nk))  {}
      bool operator==(const R_nk<_T0>& __other) const {
        return nk == (__other.nk);
      }
      bool operator!=(const R_nk<_T0>& __other) const {
        return std::tie(nk) != std::tie(__other.nk);
      }
      bool operator<(const R_nk<_T0>& __other) const {
        return std::tie(nk) < std::tie(__other.nk);
      }
...
namespace K3 {
  template <class _T0>
  class patcher<R_nk<_T0>> {
    public:
        static void patch(std::string _input, R_nk<_T0>& _record)  {
          shallow<string::iterator> _shallow;
          qi::rule<string::iterator,
          qi::space_type> _nk = (qi::lit("nk") >> (':') >> _shallow)[([&_record] (std::string _partial)   {
            do_patch(_partial, _record.nk);
          })];
          qi::rule<string::iterator, qi::space_type> _field = _nk;
          qi::rule<string::iterator, qi::space_type> _parser = ('{') >> _field % ('|') >> ('}');
          qi::phrase_parse(std::begin(_input), std::end(_input), _parser, qi::space);
        }
  };
...
#define K3_R_nk
template <class _T0>
std::size_t hash_value(const R_nk<_T0>& r)  {
  boost::hash<std::tuple<_T0>> hasher;
  return hasher(std::tie(r.nk));
}
#endif
...
public K3::__time_context {
  public:
      ...
      K3::__time_context()  {
        dispatch_table[__sp_rhs_scan_tid] = [this] (void* payload)   {
          sp_rhs_scan(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__sp_rhs_peer_barrier_tid] = [this] (void* payload)   {
          sp_rhs_peer_barrier(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__sp_probe_rhs_tid] = [this] (void* payload)   {
          sp_probe_rhs(*(static_cast<_Collection<R_key_value<int,
          _Collection<R_nk<int>>>>*>(payload)));
        };
        dispatch_table[__sp_lhs_scan_tid] = [this] (void* payload)   {
          sp_lhs_scan(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__sp_lhs_peer_barrier_tid] = [this] (void* payload)   {
          sp_lhs_peer_barrier(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__sp_global_barrier_tid] = [this] (void* payload)   {
          sp_global_barrier(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__sp_build_lhs_tid] = [this] (void* payload)   {
          sp_build_lhs(*(static_cast<_Collection<R_key_value<int, _Map<R_key_value<int,
          double>>>>*>(payload)));
        };
        ...
        dispatch_table[__ps_probe_rhs_tid] = [this] (void* payload)   {
          ps_probe_rhs(*(static_cast<_Collection<R_elem<int>>*>(payload)));
        };
        dispatch_table[__nation_trig_tid] = [this] (void* payload)   {
          nation_trig(*(static_cast<unit_t*>(payload)));
        };
        dispatch_table[__partsupp_supplier_tid] = [this] (void* payload)   {
          partsupp_supplier(*(static_cast<unit_t*>(payload)));
        };
      }
      static int __partsupp_supplier_tid;
      static int __nation_trig_tid;
      static int __ps_probe_rhs_tid;
      ...
      static int __sp_build_lhs_tid;
      static int __sp_global_barrier_tid;
      static int __sp_lhs_peer_barrier_tid;
      static int __sp_lhs_scan_tid;
      static int __sp_probe_rhs_tid;
      static int __sp_rhs_peer_barrier_tid;
      static int __sp_rhs_scan_tid;
      Address me;
      ...
      K3::base_string, int, int, double>> partsupp;
      ...
      int>> nation;
      _Map<R_key_value<int, _Map<R_key_value<int, double>>>> p_by_suppkey_map;
      _Map<R_key_value<int, _Collection<R_nk<int>>>> s_by_suppkey_map;
      _Map<R_key_value<int, _Map<R_key_value<int, double>>>> ps_map;
      _Map<R_key_value<int, double>> q11_result;
      double total;
      bool __total_set__ = false;
      auto combine_maps(const R_key_value<int, _Map<R_key_value<int, double>>>& a)  {
        return [this, &a] (const R_key_value<int, _Map<R_key_value<int, double>>>& b) mutable  {
          {
            _Map<R_key_value<int, double>> a2;
            a2 = (b.value).fold(std::move([this] (_Map<R_key_value<int, double>> acc) mutable  {
              return [this, acc = std::move(acc)] (const R_key_value<int, double>& x) mutable  {
                acc.insert_with(std::move(x), std::move([this] (const R_key_value<int,
                double>& z) mutable  {
                  return [this, &z] (const R_key_value<int, double>& y) mutable  {
                    return R_key_value<int, double> {z.key, (z.value) + (y.value)};
                  };
                }));
                return std::move(acc);
              };
            }), std::move(a.value));
            return R_key_value<int, _Map<R_key_value<int, double>>> {a.key, a2};
          }
        };
      }
      unit_t partsupp_supplier(unit_t _)  {
        return peers.iterate(std::move([this] (const R_addr<Address>& p) mutable  {
          auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
          __engine.send(p.addr, __sp_lhs_scan_tid, d);
          return unit_t {};
        }));
      }
      unit_t nation_trig(unit_t _)  {
        {
          ...
          return peers.iterate(std::move([this, &german_ids] (const R_addr<Address>& p) mutable  {
            auto d = std::make_shared<K3::ValDispatcher<_Collection<R_elem<int>>>>(german_ids);
            __engine.send(p.addr, __ps_probe_rhs_tid, d);
            return unit_t {};
          }));
        }
      }
      unit_t ps_probe_rhs(const _Collection<R_elem<int>>& ns)  {
        ns.iterate(std::move([this] (const R_elem<int>& n) mutable  {
          shared_ptr<R_key_value<int, _Map<R_key_value<int, double>>>> __0;
          __0 = ps_map.lookup(R_key_value<int, _Map<R_key_value<int, double>>> {n.elem,
          _Map<R_key_value<int, double>> {}});
          if (__0) {
            auto& ps = *(__0);
            return (ps.value).iterate(std::move([this] (const R_key_value<int,
            double>& m) mutable  {
              q11_result.insert_with(m, std::move([this] (const R_key_value<int,
              double>& a) mutable  {
        ...
        }));
        {
          double total2;
          total2 = total * (1.0e-4);
          q11_result = q11_result.filter(std::move([this, &total2] (const R_key_value<int,
          double>& x) mutable  {
            return (x.value) > total2;
          }));
          loc_done_cnt = loc_done_cnt + (1);
          if (loc_done_cnt == peers.size(unit_t {})) {
            auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
      ...
      int loc_done_cnt;
      bool __loc_done_cnt_set__ = false;
      Address master;
      ...
      unit_t load_all(unit_t _)  {
        {
          ...
          start = now_int(unit_t {});
          {
            ...
            partsuppFiles.iterate(std::move([this] (R_path<K3::base_string> e) mutable  {
              return partsuppLoader(std::move(e.path), partsupp);
            }));
            result = nationFiles.iterate(std::move([this] (R_path<K3::base_string> e) mutable  {
      ...
      unit_t ready(unit_t _)  {
        ...
        if (nodes_ready_cnt == peers.size(unit_t {})) {
          ...
          auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
          __engine.send(me, __partsupp_supplier_tid, d);
          return unit_t {};
        } else {
          return unit_t {};
        }
      ...
      unit_t sp_build_lhs(const _Collection<R_key_value<int, _Map<R_key_value<int,
      double>>>>& vals)  {
        return vals.iterate(std::move([this] (const R_key_value<int, _Map<R_key_value<int,
        double>>>& p) mutable  {
          return p_by_suppkey_map.insert_with(std::move(p), std::bind(&__global_context::combine_maps, std::ref(*this), std::placeholders::_1));
        }));
      }
      unit_t sp_global_barrier(unit_t _)  {
        sp_join_done_cnt = sp_join_done_cnt + (1);
        if (sp_join_done_cnt == peers.size(unit_t {})) {
          print("Hash join done.");
          return print("PS-S join all nodes finished.");
        } else {
          return unit_t {};
        }
      }
      unit_t sp_lhs_peer_barrier(unit_t _)  {
        print("Hash join LHS finished build.");
        sp_peer_build_done_cnt = sp_peer_build_done_cnt + (1);
        if (sp_peer_build_done_cnt == peers.size(unit_t {})) {
          return peers.iterate(std::move([this] (const R_addr<Address>& p) mutable  {
            auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
            __engine.send(p.addr, __sp_rhs_scan_tid, d);
            return unit_t {};
          }));
        } else {
          return unit_t {};
      ...
      unit_t sp_lhs_scan(unit_t _)  {
        ((partsupp.groupBy(std::move([this] (const R_ps_availqty_ps_comments_ps_partkey_ps_suppkey_ps_supplycost<int,
        K3::base_string, int, int, double>& p) mutable  {
          return p.ps_suppkey;
        }), std::move([this] (_Map<R_key_value<int, double>> acc1) mutable  {
          return [this,
          acc1 = std::move(acc1)] (const R_ps_availqty_ps_comments_ps_partkey_ps_suppkey_ps_supplycost<int,
          K3::base_string, int, int, double>& p) mutable  {
            acc1.insert(R_key_value<int, double> {p.ps_partkey,
            (p.ps_availqty) * (p.ps_supplycost)});
            return std::move(acc1);
          };
        }), _Map<R_key_value<int, double>> {})).groupBy(std::move([this] (const R_key_value<int,
        _Map<R_key_value<int, double>>>& v) mutable  {
          return index_by_hash(std::move(v.key));
        }), std::move([this] (_Collection<R_key_value<int, _Map<R_key_value<int,
        double>>>> acc) mutable  {
          return [this, acc = std::move(acc)] (const R_key_value<int, _Map<R_key_value<int,
          double>>>& v) mutable  {
            acc.insert(std::move(v));
            return std::move(acc);
          };
        }), _Collection<R_key_value<int, _Map<R_key_value<int,
        double>>>> {})).iterate(std::move([this] (const R_key_value<int,
        _Collection<R_key_value<int, _Map<R_key_value<int, double>>>>>& v) mutable  {
          ...
          if (__1) {
            ...
            _Map<R_key_value<int, double>>>>>>(v.value);
            __engine.send(p.addr, __sp_build_lhs_tid, d);
            return unit_t {};
          } else {
        ...
        return ignore(std::move(peers.iterate(std::move([this] (const R_addr<Address>& p) mutable  {
          auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
          __engine.send(p.addr, __sp_lhs_peer_barrier_tid, d);
          return unit_t {};
        }))));
      }
      unit_t sp_probe_rhs(const _Collection<R_key_value<int, _Collection<R_nk<int>>>>& vals)  {
        return vals.iterate(std::move([this] (const R_key_value<int,
        _Collection<R_nk<int>>>& s) mutable  {
          shared_ptr<R_key_value<int, _Map<R_key_value<int, double>>>> __2;
          __2 = p_by_suppkey_map.lookup(R_key_value<int, _Map<R_key_value<int, double>>> {s.key,
          _Map<R_key_value<int, double>> {}});
          if (__2) {
            auto& p = *(__2);
            return (s.value).iterate(std::move([this, &p] (const R_nk<int>& sval) mutable  {
              return ps_map.insert_with(R_key_value<int, _Map<R_key_value<int, double>>> {sval.nk,
              p.value}, std::bind(&__global_context::combine_maps, std::ref(*this), std::placeholders::_1));
            }));
          } else {
            return unit_t {};
          }
      ...
      unit_t sp_rhs_peer_barrier(unit_t _)  {
        sp_rhs_done_cnt = sp_rhs_done_cnt + (1);
        if (sp_rhs_done_cnt == peers.size(unit_t {})) {
          print("Hash join RHS finished probe.");
          print("PS-S join finished orders probe.");
          auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
          __engine.send(me, __nation_trig_tid, d);
          auto d2 = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
          __engine.send(master, __sp_global_barrier_tid, d2);
          return unit_t {};
        } else {
          return unit_t {};
        }
      }
      unit_t sp_rhs_scan(unit_t _)  {
        sp_lhs_done_cnt = sp_lhs_done_cnt + (1);
        if (sp_lhs_done_cnt == peers.size(unit_t {})) {
          ((supplier.groupBy(std::move([this] (const R_s_acctbal_s_address_s_comments_s_name_s_nationkey_s_phone_s_suppkey<double,
          K3::base_string, K3::base_string, K3::base_string, int, K3::base_string,
          int>& s) mutable  {
            return s.s_suppkey;
          }), std::move([this] (_Collection<R_nk<int>> acc2) mutable  {
            return [this,
            acc2 = std::move(acc2)] (const R_s_acctbal_s_address_s_comments_s_name_s_nationkey_s_phone_s_suppkey<double,
            K3::base_string, K3::base_string, K3::base_string, int, K3::base_string,
            int>& s) mutable  {
              acc2.insert(R_nk<int> {s.s_nationkey});
              return std::move(acc2);
            };
          }), _Collection<R_nk<int>> {})).groupBy(std::move([this] (const R_key_value<int,
          _Collection<R_nk<int>>>& v) mutable  {
            return index_by_hash(std::move(v.key));
          }), std::move([this] (_Collection<R_key_value<int,
          _Collection<R_nk<int>>>> acc) mutable  {
          ...
          _Collection<R_nk<int>>>> {})).iterate(std::move([this] (const R_key_value<int,
          _Collection<R_key_value<int, _Collection<R_nk<int>>>>>& v) mutable  {
            shared_ptr<R_addr<Address>> __3;
            __3 = peers.at(std::move(v.key));
            if (__3) {
              auto& p = *(__3);
              auto d = std::make_shared<K3::ValDispatcher<_Collection<R_key_value<int,
              _Collection<R_nk<int>>>>>>(v.value);
              __engine.send(p.addr, __sp_probe_rhs_tid, d);
              return unit_t {};
            } else {
              return error<unit_t>(unit_t {});
            }
          ...
          return ignore(std::move(peers.iterate(std::move([this] (const R_addr<Address>& p) mutable  {
            auto d = std::make_shared<K3::ValDispatcher<unit_t>>(unit_t {});
            __engine.send(p.addr, __sp_rhs_peer_barrier_tid, d);
            return unit_t {};
          }))));
        } else {
          return unit_t {};
      ...
      int sp_join_done_cnt;
      bool __sp_join_done_cnt_set__ = false;
      int sp_lhs_done_cnt;
      bool __sp_lhs_done_cnt_set__ = false;
      int sp_peer_build_done_cnt;
      bool __sp_peer_build_done_cnt_set__ = false;
      int sp_rhs_done_cnt;
      bool __sp_rhs_done_cnt_set__ = false;
      unit_t initDecls(unit_t _)  {
        if (!(__total_set__)) {
          total = 0;
          __total_set__ = true;
        }
        if (!(__loc_done_cnt_set__)) {
          loc_done_cnt = 0;
          __loc_done_cnt_set__ = true;
        }
        if (!(__master_set__)) {
        ...
        if (!(__sp_join_done_cnt_set__)) {
          sp_join_done_cnt = 0;
          __sp_join_done_cnt_set__ = true;
        }
        if (!(__sp_lhs_done_cnt_set__)) {
          sp_lhs_done_cnt = 0;
          __sp_lhs_done_cnt_set__ = true;
        }
        if (!(__sp_peer_build_done_cnt_set__)) {
          sp_peer_build_done_cnt = 0;
          __sp_peer_build_done_cnt_set__ = true;
        }
        if (!(__sp_rhs_done_cnt_set__)) {
          sp_rhs_done_cnt = 0;
          __sp_rhs_done_cnt_set__ = true;
        }
        return unit_t {};
      }
      std::map<std::string, std::string> __prettify()  {
        std::map<std::string, std::string> result;
        result["sp_rhs_done_cnt"] = K3::prettify_int(sp_rhs_done_cnt);
        result["sp_peer_build_done_cnt"] = K3::prettify_int(sp_peer_build_done_cnt);
        result["sp_lhs_done_cnt"] = K3::prettify_int(sp_lhs_done_cnt);
        result["sp_join_done_cnt"] = K3::prettify_int(sp_join_done_cnt);
        ...
        result["loc_done_cnt"] = K3::prettify_int(loc_done_cnt);
        ...
        result["total"] = K3::prettify_real(total);
        result["q11_result"] = K3::prettify_collection(q11_result, [] (R_key_value<int,
        double> x)   {
        ...
        result["ps_map"] = K3::prettify_collection(ps_map, [] (R_key_value<int,
        _Map<R_key_value<int, double>>> x)   {
          return K3::prettify_record(x, [] (R_key_value<int, _Map<R_key_value<int, double>>> x)   {
            ostringstream oss;
            oss << ("{");
            oss << std::string("key:") << K3::prettify_int(x.key);
            oss << (",");
        ...
        result["s_by_suppkey_map"] = K3::prettify_collection(s_by_suppkey_map, [] (R_key_value<int,
        _Collection<R_nk<int>>> x)   {
          return K3::prettify_record(x, [] (R_key_value<int, _Collection<R_nk<int>>> x)   {
            ostringstream oss;
            oss << ("{");
            oss << std::string("key:") << K3::prettify_int(x.key);
            oss << (",");
            oss << std::string("value:") << K3::prettify_collection(x.value, [] (R_nk<int> x)   {
              return K3::prettify_record(x, [] (R_nk<int> x)   {
                ostringstream oss;
                oss << ("{");
                oss << std::string("nk:") << K3::prettify_int(x.nk);
                oss << ("}");
                return string_impl(oss.str());
              });
            });
        ...
        result["p_by_suppkey_map"] = K3::prettify_collection(p_by_suppkey_map, [] (R_key_value<int,
        _Map<R_key_value<int, double>>> x)   {
          return K3::prettify_record(x, [] (R_key_value<int, _Map<R_key_value<int, double>>> x)   {
            ostringstream oss;
            oss << ("{");
        ...
        result["partsupp"] = K3::prettify_collection(partsupp,
        [] (R_ps_availqty_ps_comments_ps_partkey_ps_suppkey_ps_supplycost<int, K3::base_string, int,
        int, double> x)   {
          return K3::prettify_record(x,
          [] (R_ps_availqty_ps_comments_ps_partkey_ps_suppkey_ps_supplycost<int, K3::base_string,
          int, int, double> x)   {
            ostringstream oss;
            oss << ("{");
            oss << std::string("ps_partkey:") << K3::prettify_int(x.ps_partkey);
            oss << (",");
            oss << std::string("ps_suppkey:") << K3::prettify_int(x.ps_suppkey);
            oss << (",");
            oss << std::string("ps_availqty:") << K3::prettify_int(x.ps_availqty);
            oss << (",");
            oss << std::string("ps_supplycost:") << K3::prettify_real(x.ps_supplycost);
            oss << (",");
            oss << std::string("ps_comments:") << K3::prettify_string(x.ps_comments);
            oss << ("}");
            return string_impl(oss.str());
          });
        });
      ...
      void __patch(std::map<std::string, std::string> bindings)  {
        if (bindings.count("sp_rhs_done_cnt") > (0)) {
          do_patch(bindings["sp_rhs_done_cnt"], sp_rhs_done_cnt);
          __sp_rhs_done_cnt_set__ = true;
        }
        if (bindings.count("sp_peer_build_done_cnt") > (0)) {
          do_patch(bindings["sp_peer_build_done_cnt"], sp_peer_build_done_cnt);
          __sp_peer_build_done_cnt_set__ = true;
        }
        if (bindings.count("sp_lhs_done_cnt") > (0)) {
          do_patch(bindings["sp_lhs_done_cnt"], sp_lhs_done_cnt);
          __sp_lhs_done_cnt_set__ = true;
        }
        if (bindings.count("sp_join_done_cnt") > (0)) {
          do_patch(bindings["sp_join_done_cnt"], sp_join_done_cnt);
          __sp_join_done_cnt_set__ = true;
        }
        ...
        if (bindings.count("loc_done_cnt") > (0)) {
          do_patch(bindings["loc_done_cnt"], loc_done_cnt);
          __loc_done_cnt_set__ = true;
        }
        ...
        if (bindings.count("total") > (0)) {
          do_patch(bindings["total"], total);
          __total_set__ = true;
        }
        if (bindings.count("q11_result") > (0)) {
          do_patch(bindings["q11_result"], q11_result);
        }
        if (bindings.count("ps_map") > (0)) {
          do_patch(bindings["ps_map"], ps_map);
        }
        if (bindings.count("s_by_suppkey_map") > (0)) {
          do_patch(bindings["s_by_suppkey_map"], s_by_suppkey_map);
        }
        if (bindings.count("p_by_suppkey_map") > (0)) {
          do_patch(bindings["p_by_suppkey_map"], p_by_suppkey_map);
        }
        ...
        if (bindings.count("partsupp") > (0)) {
          do_patch(bindings["partsupp"], partsupp);
        }
...
int __global_context::__partsupp_supplier_tid;
int __global_context::__nation_trig_tid;
int __global_context::__ps_probe_rhs_tid;
...
int __global_context::__sp_build_lhs_tid;
int __global_context::__sp_global_barrier_tid;
int __global_context::__sp_lhs_peer_barrier_tid;
int __global_context::__sp_lhs_scan_tid;
int __global_context::__sp_probe_rhs_tid;
int __global_context::__sp_rhs_peer_barrier_tid;
int __global_context::__sp_rhs_scan_tid;
int main(int argc, char** argv)  {
  __global_context::__partsupp_supplier_tid = 0;
  __global_context::__nation_trig_tid = 1;
  __global_context::__ps_probe_rhs_tid = 2;
  __global_context::__start_tid = 3;
  __global_context::__finished_tid = 4;
  __global_context::__hello_tid = 5;
  __global_context::__load_all_tid = 6;
  __global_context::__ready_tid = 7;
  __global_context::__shutdown_tid = 8;
  __global_context::__sp_build_lhs_tid = 9;
  __global_context::__sp_global_barrier_tid = 10;
  __global_context::__sp_lhs_peer_barrier_tid = 11;
  __global_context::__sp_lhs_scan_tid = 12;
  __global_context::__sp_probe_rhs_tid = 13;
  __global_context::__sp_rhs_peer_barrier_tid = 14;
  __global_context::__sp_rhs_scan_tid = 15;
  __k3_context::__trigger_names[__global_context::__sp_rhs_scan_tid] = "sp_rhs_scan";
  __k3_context::__trigger_names[__global_context::__sp_rhs_peer_barrier_tid] = "sp_rhs_peer_barrier";
  __k3_context::__trigger_names[__global_context::__sp_probe_rhs_tid] = "sp_probe_rhs";
  __k3_context::__trigger_names[__global_context::__sp_lhs_scan_tid] = "sp_lhs_scan";
  __k3_context::__trigger_names[__global_context::__sp_lhs_peer_barrier_tid] = "sp_lhs_peer_barrier";
  __k3_context::__trigger_names[__global_context::__sp_global_barrier_tid] = "sp_global_barrier";
  __k3_context::__trigger_names[__global_context::__sp_build_lhs_tid] = "sp_build_lhs";
  ...
  __k3_context::__trigger_names[__global_context::__ps_probe_rhs_tid] = "ps_probe_rhs";
  __k3_context::__trigger_names[__global_context::__nation_trig_tid] = "nation_trig";
  __k3_context::__trigger_names[__global_context::__partsupp_supplier_tid] = "partsupp_supplier";
  __k3_context::__clonable_dispatchers[__global_context::__sp_rhs_scan_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__sp_rhs_peer_barrier_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__sp_probe_rhs_tid] = make_shared<ValDispatcher<_Collection<R_key_value<int,
  _Collection<R_nk<int>>>>>>();
  __k3_context::__clonable_dispatchers[__global_context::__sp_lhs_scan_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__sp_lhs_peer_barrier_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__sp_global_barrier_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__sp_build_lhs_tid] = make_shared<ValDispatcher<_Collection<R_key_value<int,
  _Map<R_key_value<int, double>>>>>>();
  ...
  __k3_context::__clonable_dispatchers[__global_context::__ps_probe_rhs_tid] = make_shared<ValDispatcher<_Collection<R_elem<int>>>>();
  __k3_context::__clonable_dispatchers[__global_context::__nation_trig_tid] = make_shared<ValDispatcher<unit_t>>();
  __k3_context::__clonable_dispatchers[__global_context::__partsupp_supplier_tid] = make_shared<ValDispatcher<unit_t>>();
  Options opt;
